...
public class TellUsAboutAdditionalMembersOfYourHouseholdCoCoPageSteps {
   ...
   @Then("I enter details on tell us about additional members of your household page and continue with {string}, {string}, {string}, {string}, and applying {string}")
   public void EnterspecificAdditionalMemberDetailsCoCo(String Name, String DOB, String gender, String Relation, String applying) {
      tellUsAboutAdditionalMembersOfYourHouseholdCoCoPage.specificAdditionalMemberDetailsCoCo(Name, DOB, gender, Relation, applying);
   }

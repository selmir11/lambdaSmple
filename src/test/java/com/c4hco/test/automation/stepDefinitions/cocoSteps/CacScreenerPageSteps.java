...
public class CacScreenerPageSteps {
    ...
    @And("I validate CAC Screener questions are {string}")
    public void iValidateQuestionsDisabledEnabled(String status) { cacScreenerPage.QuestionsDisabledEnabled(status); }

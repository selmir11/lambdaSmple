...
import com.c4hco.test.automation.pages.exchPages.ReportALifeChange_LR;
import io.cucumber.java.en.And;

public class ReportALifeChangeSteps {

    ReportALifeChange_LR lce = new ReportALifeChange_LR();

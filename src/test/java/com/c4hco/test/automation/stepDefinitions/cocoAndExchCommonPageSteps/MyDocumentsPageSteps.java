...
MyDocumentsPage myDocumentsPage = new MyDocumentsPage(WebDriverManager.getDriver());
    ...
    @Then("I validate {string} notice in {string} for {string} members")
    public void iValidateNotice(String expectedText, String language, String memberNumber) throws IOException {
        myDocumentsPage.verifyPDFText(expectedText, language, memberNumber);
    }

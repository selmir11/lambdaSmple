...
public class OtherHealthCoverageSteps_Elmo {
    ...
    public void iSelectInsuranceOptionOnly(String insuranceOption){
        otherHealthCoveragePage_Elmo.selectInsuranceOptionOnly(insuranceOption);
    }


    @Then("I click continue on the ELMO health coverage page")
    public void iClickSaveAndContinue(){
        otherHealthCoveragePage_Elmo.clickSaveAndContinue();}
    ...
    public void iVerifyHelpTextForQuestions(String language, String insurance){
        otherHealthCoveragePage_Elmo.verifyHelpDrawerTextForQuestions(language, insurance);
    }
    ...
    public void iVerifyHelpDrawerHeader(String language){
        otherHealthCoveragePage_Elmo.verifyHelpDrawerHeaderText(language);
    }
    ...
    public void iVerifyHelpDrawerBody(String language){
        otherHealthCoveragePage_Elmo.verifyHelpDrawerBodyText(language);
    }
    ...
    public void iVerifyHelpDrawerFooter(String language){
        otherHealthCoveragePage_Elmo.verifyHelpDrawerFooterText(language);
    }

    @Then("I click Go back on the ELMO health coverage page")
    public void iClickGoBack(){
        otherHealthCoveragePage_Elmo.clickGoBack();}


    // ############################## VALIDATION STEPS #########################
    // Add only validation methods below this line
    @And("I verify text on the Other Health Coverage page in {string}")
    public void iVerifyTextOnOtherHealthCoveragePage(String language){
        otherHealthCoveragePage_Elmo.verifyTextOnOtherHealthCoveragePage(language);
    }
    @And("I verify the checkboxes on the Other Health Coverage page")
    public void iVerifyCheckboxesOnOtherHealthCoveragePage(){
        otherHealthCoveragePage_Elmo.verifyCheckboxesOnOtherHealthCoveragePage();
    }
    @And("I verify help icons on the Other Health Coverage page")
    public void iVerifyHelpIconsOnOtherHealthCoveragePage(){
        otherHealthCoveragePage_Elmo.verifyHelIconsOnOtherHealthCoveragePage();
    }
    @And("I verify the header for Primary Member on the Other Health Coverage page")
    public void iVerifyHeadersOtherHealthCoveragePageEnglish(){
        otherHealthCoveragePage_Elmo.verifyHeadersOtherHealthCoveragePageEnglish();}
    @And("I validate Other Health Coverage options load {string}")
    public void iVerifyCheckboxesAttribute(String checkboxExpected){
        otherHealthCoveragePage_Elmo.verifyCheckboxesAttribute(checkboxExpected);}

    @And("I verify error message in {string} on the Other Health Coverage page")
    public void iVerifyErrorMessage(String language){
        otherHealthCoveragePage_Elmo.verifyErrorMessage(language);}

    @And("I verify error message does not show for Individual Insurance page")
    public void iVerifyNoErrorMessage()  {
        otherHealthCoveragePage_Elmo.verifyNoErrorMessage();}

    @And("I verify the text on Other Health Coverage page data in {string}")
    public void iVerifyVaHealthcarePageData(String language) {
        otherHealthCoveragePage_Elmo.verifyOhcPageData(language);}

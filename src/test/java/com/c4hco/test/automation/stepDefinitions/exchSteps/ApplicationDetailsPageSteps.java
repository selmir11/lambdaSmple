...
public class ApplicationDetailsPageSteps {
    ...
    @Then("I validate PDF OHC data {string} in {string} with Premium {string} Currently enrolled {string} {string} {string} {string} {string}")
    public void iVerifyOhcPdfText(String data, String language, String premium, String enrolled, String insruanceEnding, String ending, String lastSet, String voluntarily) throws IOException {applicationDetailsPage.verifyOhcPdfText(data, language, premium, enrolled, insruanceEnding, ending, lastSet, voluntarily);}

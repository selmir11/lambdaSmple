...
Feature: Page Text-Welcome Page
  ...
  Background: I go the login portal
    ...
    And I enter valid credential STG username "MGC4Test+apindayejkkzapeliz@gmail.com" PW "ALaska12!" QA username "qatestusercoco@test.com" PW "ALaska13!" for individual user without sign in any env

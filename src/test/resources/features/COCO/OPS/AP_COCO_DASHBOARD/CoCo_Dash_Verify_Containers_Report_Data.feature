...
Feature: CoCo Dashboard: Verify Containers and Reports header and footer
  ...
  Scenario: SLCR-833 Verify Containers on CoCo dashboard
    ...
    And I validate CoCo dashboard container titles: "Plans" "Account Summary" "Reports" are displayed
  ...
  @SLCR-833
  Scenario: SLCR-833 Verify Exclusion Reason reports page Header and Footer
    Given I open the login page on the "admin" portal
  ...
  @SLCR-833
  Scenario: SLCR-833 Verify Detailed EDI report page Header and Footer
    Given I open the login page on the "admin" portal
    And I validate I am on the "Admin Login" page
    Then I login as Admin User any environment "adminPortalADUser_UN_STG" password "adminPortalADUser_PW_STG" and "adminPortalADUser_UN_QA" password "adminPortalADUser_PW_QA"
    And I validate I am on the "Admin Portal search" page
    ...
    And I logout from Admin Portal
  @SLCR-833
  Scenario: SLCR-833 Verify Account Activity report page Header and Footer
    Given I open the login page on the "admin" portal
    And I validate I am on the "Admin Login" page
    Then I login as Admin User any environment "adminPortalADUser_UN_STG" password "adminPortalADUser_PW_STG" and "adminPortalADUser_UN_QA" password "adminPortalADUser_PW_QA"
    And I validate I am on the "Admin Portal search" page

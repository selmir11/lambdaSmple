@COCOSES @SIR-COCO13 @COCOMedicalResults
#contains SLCR-189, SLCR-193, SLCR-194
Feature: Broker Assisted - End to End Test - Open Enrollment SES
#Failing-general progression issues in Admin area - not a clean line of functions to test out the SIR pages
  Background: I go the login portal
    Given I open the login page on the "login" portal

  @SLCR-189
  Scenario: SLCR-189 - This will create Individual adult with Broker assistance for COCO SES enrollment
  ...
  @SLCR-193
  Scenario: SLCR-193 - This will create 2 couples/ 2 different plans with Broker assistance for COCO SES enrollment
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation
    ...
    Then I validate I am on the "Start Shopping" page
    Then I click "No" to the Tobacco usage question on start shopping page for "Primary,Wife,Son,DaughterInLaw" coco
    Then I click continue on coco start shopping page
  ...
  @SLCR-194
  Scenario: SLCR-194 - This will create couple with children with Broker assistance for COCO SES enrollment
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation

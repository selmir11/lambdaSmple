...
Feature: CoupleWithChildrens - End to End Test
  ...
  @SIR-2810-COCO-WIP
  Scenario: This will create Family of 9 members, Couple and their children in one group
    ...
    Then I enter details on tell us about yourself page and continue with "01161968", "Male", and applying "Yes"
    And I enter my residential address "1234 Road", "Denver", "CO", "80205", "DENVER"
    And I select "Yes" for mailing address option
    And I select "Yes" for live in Colorado option
    And I click continue on the Add info for yourself page

    #/// SELENIUM COCO /// Replace the three old steps you have with these two new ones
    ...
    Then I enter details on tell us about additional members of your household page with "Wife", "03051971", "Female", and applying "Yes"
    |Primary:Spouse|
    ...
    #
    Then I validate I am on the "CoCo Tell us about additional members" page
    Then I enter details on tell us about additional members of your household page with "DaughterOne", "04211999", "Female", and applying "Yes"
    ...
    Then I validate I am on the "CoCo Tell us about additional members" page
    Then I enter details on tell us about additional members of your household page with "DaughterTwo", "04211999", "Female", and applying "Yes"
      |Primary:Child or Other dependent|
      |Wife:Child or Other dependent   |
      |DaughterOne:Sibling             |
      |SonOne:Sibling                  |
    ...
    Then I validate I am on the "CoCo Tell us about additional members" page
    Then I enter details on tell us about additional members of your household page with "DaughterThree", "04211999", "Female", and applying "Yes"
      |Primary:Child or Other dependent|
      |Wife:Child or Other dependent   |
      |DaughterOne:Sibling             |
      |SonOne:Sibling                  |
    ...
    Then I validate I am on the "CoCo Tell us about additional members" page
    Then I enter details on tell us about additional members of your household page with "DaughterFour", "04211999", "Female", and applying "Yes"
      |Primary:Child or Other dependent|
      |Wife:Child or Other dependent   |
      |DaughterOne:Sibling             |
      |SonOne:Sibling                  |
      |DaughterTwo:Sibling             |
      |DaughterThree:Sibling           |
    ...
    Then I validate I am on the "CoCo Tell us about additional members" page
    Then I enter details on tell us about additional members of your household page with "DaughterFive", "04211999", "Female", and applying "Yes"
      |Primary:Child or Other dependent  |
      |Wife:Child or Other dependent     |
      |DaughterOne:Sibling               |
      |SonOne:Sibling                    |
    ...
    Then I validate I am on the "CoCo Tell us about additional members" page
    Then I enter details on tell us about additional members of your household page with "DaughterSix", "04211999", "Female", and applying "Yes"
      |Primary:Child or Other dependent|
      |Wife:Child or Other dependent|
      |DaughterOne:Sibling               |
      |SonOne:Sibling                    |
    ...
    And I validate the Plan 1 total is "$3,719.97" on the COCO Medical Plan Results page

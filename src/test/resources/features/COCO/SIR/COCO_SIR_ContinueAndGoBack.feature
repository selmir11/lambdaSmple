...
Feature: Shopping Page - Continue and Go back functionality
  ...
  @SLCR-944
  Scenario: SLCR-944 - This will validate the Continue button, Skip and and Save and Exist buttons
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation
    ...
    And I validate the "English" Skip button is present on the COCO Medical Plan Results page
    And I validate the "English" Save and Exit button on the COCO Medical Plan Results page
    And I change the language from header to "Spanish"
    And I validate the "Spanish" Skip button is present on the COCO Medical Plan Results page
    And I validate the "Spanish" Save and Exit button on the COCO Medical Plan Results page

...
Feature: New payment portal - payment page related tests
  ...
  @SLCR-728 @CurrentandFuturePlanCoCo
  Scenario: Current and Future Plan Tab CoCo
  ...
  @SLCR-729 @CurrentandFuturePlanCoCoSpanish
  Scenario: Current and Future Plan Tab CoCo Spanish
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation
    Then I validate I am on the "Login" page
  ...
  Scenario: SLCR-867: Navigate to My Plans page and cancel a medical plan
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation
    Then I validate I am on the "Login" page
  ...
  @SLCR-903 @CancelMYPlansGoBackCoCo
  Scenario: SLCR-903: Navigate to Cancellation request page and click go back
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation
    Then I validate I am on the "Login" page

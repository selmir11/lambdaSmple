Feature: Page Text-Dependent Overview page

  Background: I go the login portal
    Given I open the login page on the "login" portal

  @SLCR-269 @PageTextAddInfoForAddMember @NVOCoCoRegression
  Scenario: Verify Dependent Overview Page Text in English
    ...
    Then I enter details on tell us about yourself page and continue with "01011975", "Female", and applying "Yes"
    ...
    Then I verify text on the Dependent Overview page in "English"

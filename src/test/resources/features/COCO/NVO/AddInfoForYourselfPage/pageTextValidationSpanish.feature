Feature: Page text, navigation, validation - Additional information for yourself page in Spanish
  ...
  Scenario: Page text, navigation, validation on the Additional information for yourself page in Spanish
    ...
    Then I validate the error messages on the Add info for yourself page in "Spanish"
    Then I click Go Back on the additional information for yourself page
    Then I click Save and Continue only on the tell us about yourself page

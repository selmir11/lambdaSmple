Feature: Page text, navigation, validation - Additional information for additional member page in Spanish

  Background: I go the login portal
    Given I open the login page on the "login" portal

  @SLCR-83 @PageTestsAddInfoForAddMembersSpanish @NVOCoCoRegression
  Scenario: Page text, navigation, validation on the Additional information for additional member page in Spanish
    ...
    Then I validate the error messages on the Add info for add member page in "Spanish"

Feature:  SES application results
  ...
  @SLCR-401 @NVOCoCoRegression
  Scenario: Verify SES text on application results page when user is SES eligible and spots are available
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation
    Then I validate I am on the "Login" page
    ...
    And I click Continue on the Declarations And Signature Page CoCo
    Then I validate I am on the "Application Results CoCo" page
    Then I verify text that the member qualifies for SES and spots are available in "English" on the App Results Page CoCo
    And I change the language from header to "Spanish"
    Then I verify text that the member qualifies for SES and spots are available in "Spanish" on the App Results Page CoCo
    And I change the language from header to "English"
    And I click on Sign Out in the Header for "Elmo"

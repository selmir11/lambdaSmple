Feature:  My Profile Page Coco
  ...
  Scenario: Verify Change of Primary Contact Page validation, Navigation, Spanish and text
    ...
    Then I enter details on tell us about additional members of your household page with "Husband", "03051989", "Male", and applying "Yes"
      | Primary:Spouse |
    ...
    Then I validate Primary Contact Change Popup "English" on My profile page CoCo

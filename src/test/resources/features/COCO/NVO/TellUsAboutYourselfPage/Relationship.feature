Feature: As a Coco user on the “Tell us about yourself” page
  ...
  @SLCR-705
  Scenario: ELIG-As a user on the “Tell us about yourself” page Off Exchange, COCO application, I need to see the relationship field on the page with error validation so that I can add additional information about household members.[CCRT-66]
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation
    Then I validate I am on the "Login" page

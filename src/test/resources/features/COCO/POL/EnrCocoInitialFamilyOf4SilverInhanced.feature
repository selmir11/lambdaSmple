Feature: Initial Application Family of 4(Silver Enhanced)
  ...
  Scenario: COCO Initial Application with Family of 4 (Silver Enhanced)
    ...
    And I click continue on the Add info for yourself page
    Then I validate I am on the "Race and Ethnicity" page
    And I select "Asian or Asian American" for race and ethnicity option for "Spouse"
    And I click continue on the Race and Ethnicity page
    ...
    And I click continue on the Add info for yourself page
    Then I validate I am on the "Race and Ethnicity" page
    And I select "Asian or Asian American" for race and ethnicity option for "Son"
    And I click continue on the Race and Ethnicity page
    And I select "No" employment option
    And I click continue on the Employment income page
    And I select None of these as additional income option

Feature: Seed03 based on Open Enrollment - COCO

  Scenario: COCO Seed 03 for OE - Family of 4
...
#    SON
    ...
    Then I click "No" to the Tobacco usage question on start shopping page for "Primary,Wife,Daughter,Son" coco

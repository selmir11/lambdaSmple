...
Feature: CoCo Authorize Assister Organization page header and footer validation via Admin Portal OBO

  @SLCR-428
  Scenario: : CoCo Authorize Assister Organization page header and footer validation for Admin User
    ...
    Then I validate I am on the "Authorize Assister Organization AP OBO" page

...
Feature: CoCo broker authorization status notices BN-0024-03 and BN-002A-04 sent to the individual

  @SLCR-415
  Scenario: Broker authorization status notices BN-0024-03 and BN-002A-04
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "coco" account creation with email "C4PortTesting"@outlook.com
    ...
    And I verify the notice Text for "BN-002A-03" in "English" for "Coco"
    Then I delete the open notice
    Then I open the notice "BN-002A-04" in "English"
    And I verify the notice Text for "BN-002A-04" in "English" for "Coco"
    Then I delete the open notice

@portCOCO @APAccountActivity
Feature: CoCo individual password reset account activity code validation via Admin Portal

  @SLCR-859
  Scenario: CoCo individual password reset account activity code validation via Admin Portal

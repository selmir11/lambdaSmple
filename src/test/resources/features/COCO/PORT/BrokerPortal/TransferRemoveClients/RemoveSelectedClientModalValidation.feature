...
Feature: Remove a selected CoCo client modal text validation

  @SLCR-403
  Scenario: Remove a selected CoCo client modal text validation
    ...
    #CoCo individual verifying their previous broker
    Then I validate I am on the "Login" page

...
Feature: Account creation page text verification
  ...
  @PORT @SLCR-73
  Scenario: Account creation page text verification
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    And I click create my account from pre-screen page
    Then I validate I am on the "Create Account" page
    And I verify Create Your Account Header in "English"
    Then I verify field headers in "English"
    And I verify account holder preferences in "English"
    And I verify information sharing options in "English"
    ...
    And I verify account holder preferences in "Spanish"
    And I verify information sharing options in "Spanish"
    And I verify text on the "Exch" "Login Footer" in "Spanish"
    Then I click on Privacy Policy in the "Individual Portal" Footer
    And I validate I am on the "Privacy Policy" page and close tab
    And I click on Terms Of Use in the "Individual Portal" Footer
    And I validate I am on the "Terms Of Use" page and close tab

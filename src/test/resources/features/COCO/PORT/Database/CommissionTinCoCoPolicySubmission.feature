@BrokerPortalCoCoDB @port @portCOCO
Feature: Agency commission TIN update for agency owner CoCo policy submission
  ...
  #Agency owner updating the agency TIN then submitting an NFA application and enrollment

...
@SLER-1869 @NVOExchRegression
Scenario: Select Immigration Status-Juvenile (Citizenship and Immigration status)-Page Text
...
And I am a member with City "Denver" in State "CO" with dob "12292004" in county "DENVER" with zipcode "80205"
...
Then I validate Citizenship and Immigration status for juvenile "English"

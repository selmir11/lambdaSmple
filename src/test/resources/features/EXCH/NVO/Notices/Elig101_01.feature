...
Feature: Eligibility Notices
  ...
  Scenario: Not Eligible; Didn't Apply; 1 person
    ...
    Then I validate "Application Results": "Ineligible: Did Not Apply" notice in "English" for "1" members
...
#    # Report a life change
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    And I click on download "Application Results" document
    Then I validate "Application Results": "Ineligible: Not CO Resident" notice in "English" for "1" members
    And I click on Sign Out in the Header for "Elmo"
...
#    Then I validate the notice "Application Results" exist in my document letter Containers
#    And I click on download "Application Results" document
#    Then I validate "Application Results": "ANAI" notice in "English" for "2" members
#    And I click on Sign Out in the Header for "Elmo"

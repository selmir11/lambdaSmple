@NVO_MVRaccounts
Feature: Eligibility 101-01 Notices as a result of MVR expiration
  ...
  @SLER-2408
  Scenario: Income MVR, Email/English
  ...
  @SLER-2408
  Scenario: Citizenship MVR, Spanish/Email
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    Then I validate I am on the "My Profile" page
    And I click on Make Changes Button
    Then I change Preferred Language Contact Method to "Spanish"
    And I click on Save Button
    Then I click on My Account in the "Elmo" Header
    Then I validate I am on the "My Account Overview" page
    Then I click on Sign Out in the Header for "NonElmo"
  ...
  @SLER-2408
  Scenario: Citizenship MVR, Spanish/Mail
    When I click create a new account on login page
    Then I click create my account from pre-screen page

...
Feature: Eligibility Notices
  ...
  Scenario: Not Eligible; Didn't Apply; 1 person
    ...
    Then I validate Mail "Application Results": "Ineligible: Did Not Apply" notice in "English" for "1" members
...
#    # Report a life change
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    And I click on download "Application Results" document
    Then I validate Mail "Application Results": "Ineligible: Not CO Resident" notice in "English" for "1" members
    And I click on Sign Out in the Header for "Elmo"
  ...
  Scenario: MA, QHP Eligible; 1 person
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    And I click on download "Application Results" document
    Then I validate Mail "Application Results": "Health First Colorado" notice in "English" for "1" members
    And I click on Sign Out in the Header for "Elmo"
...
#    Then I save the Total Savings
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    And I click on download "Application Results" document
    Then I validate Mail "Application Results": "QHP" notice in "English" for "1" members
    And I click on Sign Out in the Header for "Elmo"
  ...
  Scenario: APTC, CSR, QHP Eligible; Gain of Tribal Status; 1 person
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    And I click on download "Application Results" document
    Then I validate Mail "Application Results": "ANAI" notice in "English" for "1" members
    And I click on Sign Out in the Header for "Elmo"
  ...
  Scenario: APTC, CSR, QHP Eligible; Gain of Tribal Status; 2 person
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    And I click on download "Application Results" document
    Then I validate Mail "Application Results": "ANAI" notice in "English" for "2" members
    And I click on Sign Out in the Header for "Elmo"

Feature: Enroll  a plan from broker portal (FAMILY OF 1)
  ...
  Scenario: : EXCH initial application
    ...
    And I validate the notices Dental policy member data "EssentialSmile Colorado - Total Care"
      |Daughter|
    And I validate the notices medical policy member data "Select Health Value Bronze $6900 Medical Deductible"
      |Daughter|

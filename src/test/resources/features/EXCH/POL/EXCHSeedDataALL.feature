...
#      | 8  | SEP REASON         | ADMIN_LCE |
  ...
  Scenario: Seed 07 For Exchange -2TaxHH - Husband+Wife & Son+DIL with different address and SMOKERS
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
  ...
  Scenario: Seed 08 For Exchange-  2TaxHH Husband+Wife & Son+DIL with same address
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
...
#    Daughter In Law
  ...
  Scenario: Seed 09 For Exchange- Minor Only - FA
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page

...
Feature: ELIG Dental
  ...
  @SLER-2209
  Scenario: ELIG-Dental NFA path-Dental [RT-1296]
  ...
  @SLER-2213
  Scenario: ELIG-Dental-Button on Overview-Page Text  [RT-1297]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    Then I validate I am on the "Account Overview" page
    Then I verify the button texts in account overview page "English"
    When I change the language from header to "Spanish NonElmo"
    Then I verify the button texts in account overview page "Spanish"
    And I change the language from header to "English NonElmo"
    Then  I click on Sign Out in the Header for "NonElmo"

  @SLER-2053
  Scenario: User applies for dental with previous FA applications
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    And I click continue on the Citizenship page
    Then I validate I am on the "Family Overview" page
    Then I verify "FA" information on household page
    Then  I click on Sign Out in the Header for "NonElmo"

  @SLER-2040
  Scenario: User applies for dental with previous NFA applications
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    And I click continue on the Citizenship page
    Then I validate I am on the "Family Overview" page
    Then I verify "NFA" information on household page
    And I click on Sign Out in the Header for "NonElmo"
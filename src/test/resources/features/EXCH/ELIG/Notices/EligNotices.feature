Feature: Elig101-01 - Elig Notices
 ...
 @SLER-2468
  ...
  @SLER-2470
  Scenario: ELIG-Elig101-01- 1 member SSN and Citizenship MVR valid SEP [RT- 2964]
    Then I apply for the current year
    Then I select "No" option on the Let us guide you page
    And I click on save and continue button
    Then I click on continue with  application button on Before you begin page
    ...
    And I select "No" for Incarceration option
    And I click continue on the Add Address page
    And I select "Prefer not to answer" for race and ethnicity for "CitizenshipMVRAutomationTest"
    Then I click continue on the Race and Ethnicity page
    Then I select "Yes" for Citizen option
    And I select "No" for Naturalized Immigrant option
    And I click continue on the Citizenship page
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 Citizenship MVR English 1" notice content
  ...
  @SLER-2471
  Scenario: SLER-2471 Elig101-01- 1 member Not Eligible for APTC and CSR due to not filing taxes
    Then I apply for the current year
    Then I select "No" option on the Let us guide you page
    And I click on save and continue button
    Then I click on continue with  application button on Before you begin page
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 APTC and CSR Not eligible English 1" notice content
  ...
  Scenario: SLER-2490 Elig101-01- 1 member Not Eligible for APTC and CSR due to not filing taxes Spanish
    ...
    Then I select the option "Yes" to employment
    And I select the option "No" to self employment
    And I enter employment details with "5200000" income at "Annually" frequency
    And I select the option "No" to seasonal employment
    And I select the option "No" to projected income
    And I click continue on the Employment Info Page
    Then I click continue on the Employment Summary Page
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 APTC and CSR Not eligible Spanish 1" notice content
  ...
  @SLER-2480
  Scenario: [RT-3071] ELIG-Elig101-01- 1 member SSN and Citizenship MVR valid SEP Spanish
    And I click on the Username in the "Exch NonElmo" Header
    And I validate I am on the "My Profile" page
    And I click on Make Changes Button
    And I change Preferred Language Contact Method to "Spanish"
    ...
    And I select "No" for Incarceration option
    And I click continue on the Add Address page
    And I select "Prefer not to answer" for race and ethnicity for "CitizenshipMVRAutomationTestSP"
    Then I click continue on the Race and Ethnicity page
    Then I select "Yes" for Citizen option
    And I select "No" for Naturalized Immigrant option
    And I click continue on the Citizenship page
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 Citizenship MVR Spanish 1" notice content
  ...
  @SLER-2482
  Scenario: [RT-3075] ELIG-Elig101-01- 1 member Death MVR valid SEP Spanish
    And I click on the Username in the "Exch NonElmo" Header
    And I validate I am on the "My Profile" page
    And I click on Make Changes Button
    And I change Preferred Language Contact Method to "Spanish"
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 Death MVR Spanish 1" notice content
  ...
  @SLER-2483
  Scenario: [RT-3077] ELIG-Elig101-01- 1 member Incarcerated MVR valid SEP Spanish
    And I click on the Username in the "Exch NonElmo" Header
    And I validate I am on the "My Profile" page
    And I click on Make Changes Button
    And I change Preferred Language Contact Method to "Spanish"
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 Incarcerated MVR Spanish 1" notice content
  ...
  @SLER-2484
  Scenario: [RT-3087] ELIG-Elig101-01- 1 member Income MVR No SEP Spanish (New Implementation)
    And I click on the Username in the "Exch NonElmo" Header
    And I validate I am on the "My Profile" page
    And I click on Make Changes Button
    And I change Preferred Language Contact Method to "Spanish"
    ...
    And I select "No" for Incarceration option
    And I click continue on the Add Address page
    And I select "Prefer not to answer" for race and ethnicity for "IncomeMVRAutomationTest"
    Then I click continue on the Race and Ethnicity page
    Then I select "Yes" for Citizen option
    And I select "No" for Naturalized Immigrant option
    And I click continue on the Citizenship page
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 Income MVR Spanish 1" notice content
  ...
  Scenario: SLER-2481 Elig101-01- 1 APTC eligibility 3 members English
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "Daughter", "01012015", "Female" and applying "Yes"
      | Primary:Daughter |
      | Spouse:Daughter |
    And I click continue on Tell us about additional members page
    Then I validate I am on the "Add Address" page
    ...
    Then I select the option "Yes" to employment
    And I select the option "No" to self employment
    And I enter employment details with "7100000" income at "Annually" frequency
    And I select the option "No" to seasonal employment
    And I select the option "No" to projected income
    And I click continue on the Employment Info Page
    Then I click continue on the Employment Summary Page
    ...
    Then I validate the notice "Application Results" exist in my document letter Containers
    Then I click on download "Application Results" document
    Then I validate "ELIG-001-01 APTC English 3" notice content

...
Feature: ELIG-CYA Eligible
  ...
  @SLER-2130
  Scenario: Testing will verify system functionality for member being ineligible for MA as they are not a US Citizen or Lawfully Present
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    And I report "Birth" and click continue
    Then I select "member" from the who are you question
    And I am a member with City "Denver" in State "CO" with dob "10011985" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
    Then I validate I am on the "Find Expert Help" page
    Then I click Continue on my own button from Manage who helps you page
    ...
    And I enter employment details with "120000" income at "Annually" frequency
  ...
  @SLER-833
  Scenario: Determine Medical Assistance eligibility when user income is $12000.00
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
  ...
  @SLER-2178
  Scenario: Testing will verify system functionality for member being eligible for MA even though their income is too high because they were former foster care
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    And I report "Birth" and click continue
    Then I select "member" from the who are you question
    And I am a member with City "Denver" in State "CO" with dob "01012000" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
    Then I validate I am on the "Find Expert Help" page
    Then I click Continue on my own button from Manage who helps you page
    ...
    And I select "No" for Hardship Exemption option
    And I select "No" for Disability option
    And I select "Yes" for Foster care in state of Colorado
    And I select "No" to the recently denied medicaid question
    And I select "No" for Incarceration option
    And I click continue on the Add Address page
    And I select "Prefer not to answer" for race and ethnicity for "Primary"
    ...
    @SLER-2137
  Scenario: Testing will verify system functionality for member being ineligible for MA because their income is too high
      Given I open the login page on the "login" portal
      And I validate I am on the "Login" page
      When I click create a new account on login page
      Then I click create my account from pre-screen page

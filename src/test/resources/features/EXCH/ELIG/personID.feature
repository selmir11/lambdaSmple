...
Feature: Verify Navigation to the ELIG Pages
  ...
  @SLER-975 #TODO: This test is currently broken and needs fixed.
  ...
  @SLER-2039 @SLER-2052 @SLER-2075
  Scenario Outline:  ELIG-PersonID Combo 1-PersonID [RT-1799] PersonID Combo 3-PersonID[RT-1800] ELIG-PersonID Combo 4-PersonID[RT-1801]
    ...
    Then I create an additional member with the following relations and condition "<Memberdetail>"
      |PesronFirst:Other|
    ...
    And I click continue on the Citizenship page
    Then I click continue on family overview page
    And  I verify Persons ID are validated in the DB with count only "No"

    Examples:
      | Memberdetail              |
      | sameasprimarymember       |
      | uniquefirstnameandmiddle  |
      | uniquessn                 |


  @SLER-2081 #Do Not Run - Test isn't valid. This is a duplicate of SLER-975 but does not cover the secnario
  Scenario: PersonID No Matches-PersonID [RT-1803]
    And I enter first name "PesronFirst", middle name "personmiddle", last name "Pesronlast" and general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
    And  I enter valid credentials to login
    Then I apply for the current year
    ...
    And I click continue on the Citizenship page
    Then I click continue on family overview page
    And I verify Persons ID are validated in the DB with count only "Yes"
    And I verify Person ID review status is Manual Review Required

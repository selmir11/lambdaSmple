...
Feature:   FA NON_AIAN_LEVEL_3-CSRRules
  ...
  @SLER-2103
  Scenario: ELIG-CSR Eligible FA NON_AIAN_LEVEL_3-CSRRules [RT-1110]
  ...
  @SLER-2121
  Scenario:  ELIG-CSR Eligible FA AIAN_LEVEL_1-CSRRules [RT-1114]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
  ...
  @SLER-2135
  Scenario:   ELIG-CSR Eligible FA AIAN_LEVEL_2-CSRRules [RT-1115]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    And I click on Sign Out in the Header for "NonElmo"
    #DB STEP
    And  I verify the Member reason code as "AIAN_LEVEL_2"

  @SLER-2159
  Scenario:   ELIG-CSR Not Eligible OVER_CSR_INCOME-CSRRules [RT-1113]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    Then I validate I am on the "Application History" page
    Then I click on view results and shop
    Then I verify that "Cost-Sharing Reductions" is not present in the list


  @SLER-2161
  Scenario:  ELIG-APTC Not Eligible other insurance-APTCRules [RT-1121]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    Then I validate I am on the "Application History" page
    Then I click on view results and shop
    Then I verify that "Premium Tax Credit" is not present in the list

  @SLER-2168
  Scenario:  ELIG-CSR Not Eligible not QHP Eligible-CSR Rules [RT-1108]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
  ...
  @SLER-2169
  Scenario:   ELIG-CSR Eligible NFA AIAN_LEVEL_2-CSR Rules [RT-1109]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
  ...
  @SLER-2180
  Scenario:  ELIG-MA Not Eligible 5 year bar not met-MARules [RT-1136]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    ...
    Then I select the option "Yes" to employment
    And I select the option "No" to self employment
    And I enter employment details with "1200000" income at "Annually" frequency
    And I select the option "No" to seasonal employment
    And I select the option "No" to projected income
    And I click continue on the Employment Info Page
    Then I click continue on the Employment Summary Page
  ...
  @SLER-2181
  Scenario: ELIG-MA Not Eligible Denied MK/CHP+-MARules [RT-1139]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
  ...
  @SLER-2207
  Scenario: ELIG-MA Not Eligible keep APTC-MARules[RT-1140]
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I click create my account from pre-screen page

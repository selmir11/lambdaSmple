@ELIG
Feature: Verify Business Events in Admin Portal Account Activity

  Background:
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page

  @SLER-1997 @BusinessEvent
  Scenario: Verify "NES Application Signed and Submitted" Event in Admin Portal Account Activity
    ...
    Then I validate "UI_APP_SIGNED_SUBMIT.." event code and description "Application signed and su.." in activity event report


  @SLER-2022 @BusinessEvent
  Scenario: Verify "Self Attestation" Event in Admin Portal Account Activity.
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter first name "BusinessEvent", middle name "", last name "OPENINCOMEMVR" and general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
    And  I enter valid credentials to login
    Then I apply for the current year
    Then I select "No" option on the Let us guide you page
    ...
    And I select "No" for Incarceration option
    And I click continue on the Add Address page
    And I select "Prefer not to answer" for race and ethnicity for "BusinessEvent"
    ...
    And I validate Account Activity title row
    And I wait for 1000 milliseconds
    Then I validate "UI_INCOME_APTC_ATTES.." event code and description "User attested to Income" in activity event report

  @SLER-2144 @BusinessEvent
  Scenario: Verify "RIDP - BE_Q_AND_A_REQUESTED" Event in Admin Portal Account Activity
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
    ...
    Then I validate "BE_Q_AND_A_REQUESTED" event code and description "Questions and Answers req.." in activity event report

  @SLER-2145 @BusinessEvent
  Scenario: Verify "RIDP -  BE_ID_PROOFING_REQUESTED" Event in Admin Portal Account Activity
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
    ...
    And I validate Account Activity title row
    And I wait for 500 milliseconds
    Then I validate "BE_ID_PROOFING_REQUE.." event code and description "ID Proofing requested via.." in activity event report
...
Feature: Admin Portal agency verify data
  ...
  Scenario: Verify agency data
    ...
    Then I validate data for Agency Summary: "Hanks Enterprises Name" "9856" "986587445" "Agent: Tom Hanks" "vasanthi.soma@gmail.com" "Website:" "343-523-6524" "English, Spanish"

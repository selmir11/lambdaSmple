...
Feature: Manage Plans Individual Policy Dropdown Arrow [RT-2195]
  Scenario:SLER-2456 Individual Policy Dropdown Arrow
    ...
    Then I enter an accountId in any Env "4007020033" "2678007169" to search user
  ...
  Scenario:SLER-2456 Individual Policy Dropdown Arrow - multiple policies
    Given I open the login page on the "admin" portal
    And I validate I am on the "Admin Login" page
    Then I login as Admin User any environment "adminPortalADUser_UN_STG" password "adminPortalADUser_PW_STG" and "adminPortalADUser_UN_QA" password "adminPortalADUser_PW_QA"
    And I validate I am on the "Admin Portal search" page
    Then I enter an accountId in any Env "1203027641" "2564008767" to search user
    And I click on Search button in AP dashboard page
    And I click acct first row from Search Results table in admin portal
    Then I click on "Manage Plans" user dashboard button
    And I validate I am on the "Manage Plans" page
    ...
    Then I select the 1 "Medical" policy Plan
    And I select Plans Med Active Policy
    Then I verify Plan ID data with plan selected "5080990980" "5080990980 - 01/11/2024 - yylczk" and "5080990980" "5080990980 - 01/11/2024 - yylczk"
    Then I click Go Back button on Manage Plan page
    And I logout from Admin Portal

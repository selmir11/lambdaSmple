...
Feature: OPS: Add Dependent
  ...
  @SLER-2457
  Scenario: SLER-2457 OPS: MP: FA Adding Adult (Check Person ID)
    And I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "Spouse", "01011991", "Female" and applying "No"
      | Primary:Spouse |
    ...
    And I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "Son", "03052020", "Male" and applying "Yes"
      | Primary:Son |
      | Spouse:Son  |
    And I click continue on Tell us about additional members page
    Then I validate I am on the "Add Address" page
...
#    Complete 1st Enrollment
    ...
    Then I select "KP CO Bronze 6500/35%/HSA" medical plan
...
#    Verify Manage Plans
    ...
    Then I validate current "Medical" plan summary in DB for 2 members "" LCE on AP Manage Plans
    Then I validate current "Medical" all details table in DB for 2 members on AP Manage Plans
    Then I validate current "Dental" plan summary in DB for 2 members "" LCE on AP Manage Plans
...
#    Complete 2nd Application/Enrollment with Spouse
    And I close current tab and switch back to previous tab
    And I click "On Behalf Of (OBO)" from application links dropdown
    And I initiate incoming page
    Then I validate I am on the "Account Overview" page
    ...
    And I update member applying for coverage to "Yes"
    And I click continue on Tell us about additional members page
    And I select "No" for Hardship Exemption option
    And I select "No" for Disability option
    And I select "No" to the recently denied medicaid question
...
#    Manage Plans verify against DB
    ...
    And I validate I am on the "Manage Plans" page
    Then I validate current "Medical" plan summary in DB for 3 members "Birth" LCE on AP Manage Plans
    Then I validate current "Medical" all details table in DB for 3 members "Birth" LCE on AP Manage Plans
    Then I validate current "Dental" plan summary in DB for 3 members "Birth" LCE on AP Manage Plans
    Then I validate current "Dental" all details table in DB for 3 members "Birth" LCE on AP Manage Plans
  ...
  @SLER-2455
  Scenario: SLER-2455 Change Added Member Start Date
    Then I validate I am on the "Family Overview" page
    Then I click continue on family overview page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Complete 2nd Application/Enrollment with Spouse
    ...
    Then I click continue on the Citizenship page
    Then I click plus icon next to member on household page for "Spouse"
    Then I click the edit income icon on household page for "Spouse"
    Then I select the option "No" to employment
    And I click continue on the Employment Info Page
    Then I click None of these as additional income option and continue
...
#    Manage Plans verify against DB
    ...
    Then I validate current "Dental" plan summary in DB for 2 members "Marriage" LCE on AP Manage Plans
    Then I validate current "Dental" all details table in DB for 2 members "Marriage" LCE on AP Manage Plans
#    Edit start dates for Spouse
    Then I click Make Changes Medical button
    And I update the Coverage Start date of member
...
#    Manage Plans verify against DB
    ...
    Then I validate previous financial period "Dental" plan summary in DB for 1 policy 1 members for DB row 0 on AP Manage Plans
    Then I validate previous "Dental" all details table in DB for 1 members on policy "1" for DB row 0 on AP Manage Plans

...
#    And I close current tab and switch back to previous tab
  ...
  Scenario: SLER-2366  Upload new document, check DLT, CRM, and DB for new document
    ...
    When I login as Admin User any environment "adminPortalADUser_UN_STG" password "adminPortalADUser_PW_STG" and "adminPortalADUser_UN_QA" password "adminPortalADUser_PW_QA"
    And I validate I am on the "Admin search" page
    Then I enter an accountId in any Env "" "9047277089 " to search user
   ...
   # And I change the language from header to "Spanish"
    ...
    Then I upload another doc "TestMyDocs.docx" for "Income" on the My Documents page and verify success message
    ...
    And I click upload MVR button for "Financial Help for Eligibility" in "Spanish"

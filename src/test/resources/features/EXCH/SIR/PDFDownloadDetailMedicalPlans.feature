...
Feature: Medical Plan Detail page related tests
  ...
  @SLER-2010-WIP @MedicalDetailDocumentSuccessfulDownload
    # application properties - pdf testing row must be set to "yes" otherwise this will fail
  Scenario Outline: SLER-2010 - Validate the documents found on the Detail Plans page when the Network Links are switched (Medical)
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
  ...
  @SLER-2011-WIP @MedicalDetailDocumentSuccessfulDownload
    # application properties - pdf testing row must be set to "yes" otherwise this will fail
  Scenario Outline: SLER-2011 - Validate the documents found on the Detail Plans page when the Network Links are switched (Medical)
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
  ...
  @SLER-2012-WIP @MedicalDetailDocumentSuccessfulDownload
    # application properties - pdf testing row must be set to "yes" otherwise this will fail
  Scenario Outline: SLER-2012 - Validate the documents found on the Detail Plans page when the Network Links are switched (Medical)
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
  ...
  @SLER-2013-WIP @MedicalDetailDocumentSuccessfulDownload
    # application properties - pdf testing row must be set to "yes" otherwise this will fail
  Scenario Outline: SLER-2013 - Validate the documents found on the Detail Plans page when the Network Links are switched (Medical)
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
  ...
  @SLER-2014-WIP @MedicalDetailDocumentSuccessfulDownload
    # application properties - pdf testing row must be set to "yes" otherwise this will fail
  Scenario Outline: SLER-2014 - Validate the documents found on the Detail Plans page when the Network Links are switched (Medical)
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation

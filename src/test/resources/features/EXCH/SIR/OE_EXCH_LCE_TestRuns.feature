@SIR-EXCH14 @SIR-LCE-OE
  # SLER-1890, SLER-1891, SLER-1892, SLER-1893, SLER-1895, SLER-1896, SLER-1897, SLER-1898,
Feature: LCE Test Runs
  ...
  @SLER-1898 @VerifyLCEDeath
  Scenario: SLER-1898 - VerifyLCEDeath
    When I click create a new account on login page

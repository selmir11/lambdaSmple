@SIR-EXCH12 @SIR-LCE
  # SLER-WIP1, SLER-WIP2, SLER-WIP3, SLER-WIP4, SLER-WIP5, SLER-WIP6, SLER-WIP7, SLER-WIP8, SLER-WIP9, SLER-WIP10,
Feature: LCE Test Runs
  Background:
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page

  @SLER-WIP1 @VerifyLCEBirth
  Scenario: SLER-WIP1 - VerifyLCEBirth
  ...
  @SLER-WIP2 @VerifyLCEMarriage
  Scenario: SLER-WIP2 - VerifyLCEMarriage
    When I click create a new account on login page
  ...
  @SLER-WIP3 @VerifyLCEColorado
  Scenario: SLER-WIP3 - VerifyLCEColorado
    When I click create a new account on login page
  ...
  @SLER-WIP4 @VerifyLCEChangePrimaryResidence
  Scenario: SLER-WIP4 - VerifyLCEPrimaryResidence
    When I click create a new account on login page
  ...
  @SLER-WIP5 @VerifyLCEGainedLawfulPresence
  Scenario: SLER-WIP5 - VerifyLCEGainedLawfulPresence
    When I click create a new account on login page
  ...
  @SLER-WIP6 @VerifyLCELostCoverage
  Scenario: SLER-WIP6 - VerifyLCELostCoverage
    When I click create a new account on login page
  ...
  @SLER-WIP7 @VerifyLCEGainOfTribalStatus
  Scenario: SLER-WIP7 - VerifyLCEGainOfTribalStatus
    When I click create a new account on login page
  ...
  @SLER-WIP8 @VerifyLCEDeath
  Scenario: SLER-WIP8 - VerifyLCEDeath
    When I click create a new account on login page
    ...
    Then I click continue on family overview page
    And I Apply for no financial help
    # Death option is not available for the Primary  - just the dependents or other members
  ...
  @SLER-WIP9 @VerifyUnassignedMedicalPlanSummaryResultsMultipleLCE
  Scenario: SLER-WIP9 - Validate grouping members: 2 groups - one group is unassigned to medical plans
    When I click create a new account on login page
    Then I validate I am on the "Prescreen" page
    Then I click create my account from pre-screen page
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "SonOne", "10102020", "Male" and applying "Yes"
      |Primary:Son    |
      |Mother:Grandson|
      |Spouse:Son     |
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "SonTwo", "10102024", "Male" and applying "Yes"
      |Primary:Son    |
      |Mother:Grandson|
      |Spouse:Son     |
      |SonOne:Brother |

...
Feature: UI Tests related to plan not available message check after initial enrollment
  ...
  @SLER-2487
  Scenario: SLER-2487 - re-ernrollment with move - one group dental plan not available check - validate for English and Spanish
...
#2nd enrollment with Green Banner verification
    ...
    And I click continue on start shopping page
     ...
     # Medical plan does change
    Then I validate I am on the "Medical Plan Results" page
    And I validate the "English" Plan Not Available message on the Medical Plan Results page
    And I change the language from header to "Spanish"
    And I validate the "Spanish" Plan Not Available message on the Medical Plan Results page
    And I change the language from header to "English"
    And I select the first medical plan
    And I click continue on medical plan results page

    # Dental plan doesnt change
    Then I validate I am on the "Dental Plan Results" page
  ...
  @SLER-2486
  Scenario: SLER-2486 - re-enrollment with move - single user - both plans not available check - validate for English and Spanish
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
    ...
    Then I validate I am on the "Who Are You" page
    Then I select "member" from the who are you question
    And I am a member with City "Denver" in State "CO" with dob "01011981" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
...
#2nd enrollment with Green Banner verification
    ...
    # Dental plan does change
    Then I validate I am on the "Dental Plan Results" page
    And I validate the "English" Plan Not Available message on the Dental Plan Results page
    And I change the language from header to "Spanish"
    And I validate the "Spanish" Plan Not Available message on the Dental Plan Results page
    And I change the language from header to "English"
  ...
  Scenario: SLER-2488 - Plan Not Available for Two Tax household grouping  - group of 2  - two different zip codes - mother/daughter (daughter is under 25) -two tax households
    ...
    Then I validate I am on the "Who Are You" page
    Then I select "member" from the who are you question
    And I am a member with City "Example" in State "CO" with dob "01011980" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
    ...
    And I enter a new residential address with city "Franktown" state "CO" zip "80116" and county "DOUGLAS"
    And I select "Yes" for CO Resident option
    And I select "No" for Federally Recognized Tribe option
    And I select "No" for Hardship Exemption option
    And I select "No" for Disability option

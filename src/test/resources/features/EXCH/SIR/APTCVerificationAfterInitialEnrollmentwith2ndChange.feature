...
Feature: UI Tests related to APTC after second enrollment change
  ...
  @SLER-131-WIP
  Scenario: ELIG-APTC Eligible over 400% FPL-APTCRules - formerly RT-2349
    ...
    And I am a member with dob "01011981" in county "TELLER" with zipcode "80863"
    ...
    And I enter employment details with "51600" income at "Annually" frequency

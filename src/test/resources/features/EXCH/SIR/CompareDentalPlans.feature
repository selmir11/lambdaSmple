...
Feature: Medical Plan Results page related tests
  ...
  Scenario: SLER-1037- formerly RT- 1980 - Validate the Navigation from the Dental Plan Results page to the Compare Plans page (Dental)
    ...
    @DentalDocumentCompare-WIP
  Scenario: SLER-????- Validate the Dental plan document links on the Compare Plans page
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    ...
    Then I validate I am on the "Dental Plan Compare" page
    And And I validate "3" document columns on the Compare page

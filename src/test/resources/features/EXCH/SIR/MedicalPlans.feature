@SIR @SIREXCH @SIR-EXCH13 @MedicalPlans
  # contains SLER-73
  Feature: Tests related to medical plans
    ...
    And I report "MovedToColorado" and click continue
      ...
      And I validate I am on the "Medical Plan Results" page
    #create assertion function to validate plans viewable under prescribed but consistent variables - once established it shouldnt change
      #Then I validate the medical plans available to view

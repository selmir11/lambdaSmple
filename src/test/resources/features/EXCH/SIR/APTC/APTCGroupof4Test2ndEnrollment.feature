...
Feature: UI Tests related to APTC after second enrollment change - Group of 4
  ...
  Scenario: ELIG-APTC Eligible over 400% FPL-APTCRules - group of 4 - baseline for group APTC tests
    ...
    @SLER-675-WIP @test
    Scenario Outline: ELIG-APTC Eligible over 400% FPL- APTCRules - group of 5 - 3 under 21 with 2 adults - used to be RT-2210
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    ...
    Then I validate I am on the "Add Member" page
    Then I enter Spouse member details with "10101991" date of birth
    And I select "Female" as sex option
    And I mark the Additional member is pregnant as "No"
    ...
    And I select "Son" as relationship one option
    And I select "Brother" as relationship two option
    And I select "Brother" as relationship three option
    And I select "Yes" to Is Member Applying
    ...
    Then I validate I am on the "Dental Plan Results" page
    And I validate the Dental Plans Costs 1 has cost "<dentalCostText>"
      Examples:
      | dentalCostText |
      | $0.00          |
      | $0.00          |
  ...
  @Group5ReEnroll-WIP
  Scenario: ELIG-APTC Eligible over 400% FPL- APTCRules - group of 5 - 3 under 21 with 2 adults
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation

...
Feature: UI Tests related to APTC after second enrollment change
  ...
  Scenario: ELIG-APTC Eligible over 400% FPL-APTCRules - formerly RT-2397 - born 1982 and 2011
    ...
    @SLER-999-WIP @SLER-998-WIP @test
    Scenario Outline: ELIG-APTCRules - 1 member add enrollment - income change - formerly RT-2346 and RT-2344
      When I click create a new account on login page
      Then I click create my account from pre-screen page
      And I enter general mandatory data for "exchange" account creation
      Then I validate I am on the "Login" page
      ...
      And I click on Sign Out in the Header for "Portal"
      Examples:
      |income1      |income2    | expectedAPTC | aptc1        |
      |10000000     |1000000    | $00.00/mo    | $0.00        |
      |1500000      |1500000    | $1134.70/mo  | -$1,028.25   |

...
Feature: UI Tests related to APTC after initial enrollment
  ...
  @SLER-WIP
  Scenario: ELIG-APTC Eligible -APTCRules - formerly RT-????
  ...
  @SLER-WIP
  Scenario Outline: ELIG-APTC Eligible -APTCRules - new
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
  ...
  #income variance
    ...
    Then I validate I am on the "Application Results" page
  # APTC variance
    Then I validate that my Tax Household's APTC value is "<applicationResultAPTC>"

...
Feature: UI Tests related to APTC after second enrollment change
  ...
  @SLER-325
  Scenario: ELIG - APTC Rules - SLER-325- formerly RT-2397 - born 1982 and 2011
  ...
  @SLER-999
  Scenario Outline: ELIG- APTC Rules -  SLER-999 - formerly RT-2346 - 1 member add enrollment - income change -
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
    ...
    And I click on Sign Out in the Header for "Portal"
    Examples:
      | income1 | income2 | initialAPTCSummaryResult | expectedPostAPTCResult | postAPTCSummaryResult |
      | 1500000 | 1500000 | $0.00                    | $878.11/mo             | -$853.40              |


  @SLER-998
  Scenario Outline: ELIG - APTC Rules - SLER-998 -  formerly RT-2344 - 1 member add enrollment - income change
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
  ...
  Scenario Outline: ELIG - APTC Rules - SLER-807 - formerly RT-2400
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
    ...
    And I click on Sign Out in the Header for "Portal"
    Examples:
      | City      | State | DOB      | County | Zipcode | aptc1 | income2 | expectedAptc2 | aptc2    | DOBmember2 |
      | Leadville | CO    | 01011990 | Lake   | 80461   | $0.00 | 5240000 | $310.05/mo    | -$310.05 | 01012007   |

  @SLER-804
      # ELIG - APTC Rules - SLER-804 - formerly RT-2411
  Scenario Outline: ELIG-APTC Eligible over 400% FPL-APTCRules - formerly RT-2411
    ...
    Examples:
      | City   | State | DOB      | County | Zipcode | aptc1 | income2 | expectedAptc2 | aptc2    | DOBmember2 |
      | Granby | CO    | 01011990 | Grand  | 80446   | $0.00 | 7500000 | $334.42/mo    | -$334.42 | 01012011   |


  @SLER-802 @SLER-803 @SLER-805 @SLER-806 @SLER-808 @SLER-809
  Scenario Outline: ELIG - APTC Rules - formerly RT-2398, RT-2399, RT-2401, RT-2405, RT-2412, RT-2413
    When I click create a new account on login page
    Then I click create my account from pre-screen page

...
Feature: UI Page Validation - Broker Portal OBO
  ...
  Scenario: Broker Portal OBO - FA - LCE Birth/Adoption, Enroll in New plan
    ...
    And I am a member with City "Denver" in State "CO" with dob "08161986" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
    Then I validate I am on the "Find Expert Help" page
    And I click on Find a Broker
    And I Search authorized Broker "John Winterhouse"
  ...
  #Child
    ...
    Then I enter member details with "10102024" date of birth
  ...
  Scenario: Broker Portal OBO - FA - Single applicant, Enroll in New plan
    ...
    And I report "Birth" and click continue
    Then I select "member" from the who are you question
    And I am a member with City "Denver" in State "CO" with dob "01011997" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
    Then I validate I am on the "Find Expert Help" page
    And I click on Find a Broker

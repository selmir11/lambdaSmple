Feature: UI Page Validation - Grouping Members (Medical)
  ...
  Scenario: Validate Grouping Members Family Of 4
    ...
    And I am a member with dob "10011975" in county "PARKER" with zipcode "80134"
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter member details with "01102002" date of birth
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter member details with "02152000" date of birth
    And I select "Male" as sex option
    And I select "Son" as relationship option
    And I select "Son" as relationship one option

...
Feature: My Plans Page test
  ...
  @SLER-2055 @CurrentFuturePlansTabsSpanish
  Scenario: One Current Plan and One Future Plan in Spanish
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page
  ...
  @SLER-2313 @CancelDentalPlan
  Scenario: SLER-2313 Navigate to My Plans page and cancel a dental plan
    When I click create a new account on login page
    Then I click create my account from pre-screen page
    And I enter general mandatory data for "exchange" account creation
    Then I validate I am on the "Login" page

...
Feature: UI Page Validation - Grouping Members (Medical)
  ...
  Scenario: A family of 2, both applying,One Parent and One 26 year old son/daughter
    ...
    Then I click on continue with  application button on Before you begin page
    Then I select "member" from the who are you question
    And I am a member with City "Denver" in State "CO" with dob "10011965" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
    Then I validate I am on the "Find Expert Help" page
    Then I click Continue on my own button from Manage who helps you page
  ...
  Scenario: A family of 3 all applying for insurance,Two parents and one 29 year old son who is blind
    ...
    Then I click on continue with  application button on Before you begin page
    Then I select "member" from the who are you question
    And I am a member with City "Denver" in State "CO" with dob "10011960" in county "DENVER" with zipcode "80205"
    Then I answer all Id proofing questions and click continue
    And I click continue button on Congratulations page
    Then I validate I am on the "Find Expert Help" page
    Then I click Continue on my own button from Manage who helps you page
  ...
  Scenario: Family with two parents and a 17 year old child, Validate that one group is present
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "Spouse", "03051978", "Female" and applying "Yes"
      |Primary:Spouse|
    And I click continue on Tell us about additional members page
    Then I validate I am on the "Add Address" page
    Then I select "Household" for Residential Address
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "SonOne", "01012007", "Male" and applying "Yes"
      | Primary:Son |
      | Spouse:Son  |
    And I click continue on Tell us about additional members page
    Then I validate I am on the "Add Address" page
  ...
  Scenario: Two members both siblings in the household, Parents not applying, one group should exist
    ...
    Then I click Add Another Family Member
    Then I validate I am on the "Add Member" page
    Then I enter details on tell us about additional members of your household exch page and continue with "DaughterOne", "02012009", "Female" and applying "Yes"
      | Primary:Daughter |
      | Spouse:Daughter  |
      | SonOne:Sister    |
    And I click continue on Tell us about additional members page

@TAM @TamPdf @applicationSummaryTricare
Feature: Tests related to the Application Summary/Detail for Tricare
  ...
  @SLER-1952
  Scenario: SLER-1952 I want to verify OHC header on Application Summary and Application Details
...
#    Steps 3 & 4
    ...
    Then I validate basic PDF OHC data on Application Details in "English"
      ...
      |   TRICARE   |       Yes        |      Yes       |Current Month|         Yes                |
    And I change the language from header to "Spanish NonElmo"
    Then I click on Download as PDF on Application Details
    Then I wait for 2000 milliseconds
  ...
  @SLER-1953
  Scenario: SLER-1953 I want changes to Tricare information and see changes made to Tricare information in the Application Summary
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 6
    ...
    And I verify the OHC detail on Application Summary in "English"
      |  OHC Type   |Currently Enrolled|     End date     |
      |   TRICARE   |       Yes        |Last Current Month|
    Then I click on Download as PDF on Application Summary
    Then I wait for 2000 milliseconds
    Then I validate PDF OHC data on Application Summary in "English"
      |Coverage Type|Currently Enrolled|Insurance Ending|     End date     |Voluntarily ending insurance|
      |   TRICARE   |       Yes        |      Yes       |Last Current Month|           Yes              |
    And I change the language from header to "Spanish NonElmo"
    Then I validate I am on the "Application Summary Completed" page
    And I verify the OHC header on Application Summary in "Spanish"
    Then I click on Other Health Coverage on Application Summary
    And I verify the OHC detail on Application Summary in "Spanish"
      |  OHC Type   |Currently Enrolled|     End date     |
      |   TRICARE   |        Sí        |Last Current Month|
    Then I click on Download as PDF on Application Summary
    Then I wait for 2000 milliseconds
    Then I validate PDF OHC data on Application Summary in "Spanish"
      |Coverage Type|Currently Enrolled|Insurance Ending|     End date     |Voluntarily ending insurance|
      |   TRICARE   |       Sí         |      Sí        |Last Current Month|           Sí               |
    And I change the language from header to "English NonElmo"
#    Step 7
    And I click on Apply for Coverage in the "NonElmo" Header
    Then I apply for the current year
...
#    Step 8
  ...
  @SLER-1954
  Scenario: SLER-1954 I want changes to my Tricare information and see changes made to Tricare information in the OBO Application Details
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 6
    ...
    And I verify the basic OHC detail on Application Details
      ...
      |   TRICARE   |     Plain    |       Yes        |      Plain       |      Yes       |     Plain      |Future Day:3|    Yellow    |        No        |       Yellow        |
    Then I click on Download as PDF on Application Details
    Then I wait for 2000 milliseconds
    Then I validate basic PDF OHC data on Application Details in "English"
      |Coverage Type|Currently Enrolled|Insurance Ending|   End date  |Voluntarily ending insurance|
      |   TRICARE   |       Yes        |      Yes       | Future Day:3|           Yes              |
#    Step 7
    And I click on Apply for Coverage in the "NonElmo" Header
    Then I apply for the current year
    Then I select "No" option on the Let us guide you page
...
#    Step 8
    ...
    And I verify the basic OHC detail on Application Details
      |  OHC Type   |Type Highlight|Currently enrolled|Enrolled Highlight|Insurance ending|Ending Highlight|  End date   |Date Highlight|Voluntarily ending|Voluntarily Highlight|
      |   TRICARE   |     Plain    |       No         |      Yellow      |                |      Red       |             |     Red      |                  |        Red          |
    Then I click on Download as PDF on Application Details
    Then I wait for 2000 milliseconds
    Then I validate basic PDF OHC data on Application Details in "English"
      |Coverage Type|Currently Enrolled|Insurance Ending|   End date  |Voluntarily ending insurance|
  ...
  @SLER-1955
  Scenario: SLER-1955 I want to show and hide changes for Tricare information in the OBO Application Details Single Members
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 4
    ...
    And I verify the basic OHC detail on Application Details
      |  OHC Type   |Type Highlight|Currently enrolled|Enrolled Highlight|Insurance ending|Ending Highlight|  End date   |Date Highlight|Voluntarily ending|Voluntarily Highlight|
      |   TRICARE   |     Plain    |       Yes        |      Plain       |      Yes       |     Plain      |Current Month|     Plain    |       Yes        |       Plain         |
#    Step 5
    And I click on Apply for Coverage in the "NonElmo" Header
    Then I apply for the current year
    Then I select "No" option on the Let us guide you page

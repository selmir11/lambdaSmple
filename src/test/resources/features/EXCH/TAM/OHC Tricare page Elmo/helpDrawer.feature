...
Feature: Help Drawer-Other Health Coverage Page
  ...
  Scenario: SLER-910 Validate help drawer text on the Tricare page - English
    ...
    Then I validate Tricare "full" help drawer verbiage in "English"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "Help me understand" icon on the Tricare Page
    And I select "Please enter" icon on the Tricare Page
    Then I validate Tricare "full" help drawer verbiage in "English"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "Please enter" icon on the Tricare Page
    And I select "currently enrolled" icon on the Tricare Page
    Then I validate Tricare "currently enrolled" help drawer verbiage in "English"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "currently enrolled" icon on the Tricare Page
    And I select "60 days" icon on the Tricare Page
    Then I validate Tricare "60 days" help drawer verbiage in "English"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "60 days" icon on the Tricare Page
    And I select "voluntarily ending" icon on the Tricare Page
    Then I validate Tricare "voluntarily ending" help drawer verbiage in "English"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "voluntarily ending" icon on the Tricare Page
  ...
  Scenario: SLER-911 Validate help drawer text on the Tricare page - Spanish
    ...
    Then I click "Yes" for insurance ending in 60 days in Tricare question
    And I select "Help me understand" icon on the Tricare Page
    Then I validate Tricare "full" help drawer verbiage in "Spanish"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "Help me understand" icon on the Tricare Page
    And I select "Please enter" icon on the Tricare Page
    ...
    And I select "Please enter" icon on the Tricare Page
    And I select "currently enrolled" icon on the Tricare Page
    Then I validate Tricare "currently enrolled" help drawer verbiage in "Spanish"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "currently enrolled" icon on the Tricare Page
    And I select "60 days" icon on the Tricare Page
    Then I validate Tricare "60 days" help drawer verbiage in "Spanish"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "60 days" icon on the Tricare Page
    And I select "voluntarily ending" icon on the Tricare Page
    Then I validate Tricare "voluntarily ending" help drawer verbiage in "Spanish"
    And I click Tricare Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "voluntarily ending" icon on the Tricare Page

...
Feature: Help Drawer-Other Health Coverage Page
  ...
  Scenario: SLER-907 Validate help drawer text on the COBRA page - English
    ...
    And I select "Help me understand" icon on the Cobra Page
    And I select "Please enter" icon on the Cobra Page
    Then I validate Cobra "full" help drawer verbiage in "English"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "Please enter" icon on the Cobra Page
    And I select "currently enrolled" icon on the Cobra Page
    Then I validate Cobra "currently enrolled" help drawer verbiage in "English"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "currently enrolled" icon on the Cobra Page
    And I select "60 days" icon on the Cobra Page
    Then I validate Cobra "60 days" help drawer verbiage in "English"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "60 days" icon on the Cobra Page
    And I select "voluntarily ending" icon on the Cobra Page
    Then I validate Cobra "voluntarily ending" help drawer verbiage in "English"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "voluntarily ending" icon on the Cobra Page
  ...
  @SLER-906 @HelpDrawerCobraPage
  Scenario: SLER-906 Validate help drawer text on the Cobra page - Spanish
    And I change the language from Elmo header to "Spanish" if it isn't already in that language
    And I validate I am on the "Spanish" page
    Then I click "Yes" for currently enrolled in COBRA question
    Then I click "Yes" for insurance ending in 60 days in COBRA question
    And I select "Help me understand" icon on the Cobra Page
    Then I validate Cobra "full" help drawer verbiage in "Spanish"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "Help me understand" icon on the Cobra Page
    And I select "Please enter" icon on the Cobra Page
    ...
    And I select "Please enter" icon on the Cobra Page
    And I select "currently enrolled" icon on the Cobra Page
    Then I validate Cobra "currently enrolled" help drawer verbiage in "Spanish"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "currently enrolled" icon on the Cobra Page
    And I select "60 days" icon on the Cobra Page
    Then I validate Cobra "60 days" help drawer verbiage in "Spanish"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "60 days" icon on the Cobra Page
    And I select "voluntarily ending" icon on the Cobra Page
    Then I validate Cobra "voluntarily ending" help drawer verbiage in "Spanish"
    And I click Cobra Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "voluntarily ending" icon on the Cobra Page

@TAM @TamPdf @applicationSummaryMedicaid
Feature: Tests related to the Application Summary/Detail for Health First Colorado
  ...
  @SLER-1962
  Scenario: SLER-1962 I want to verify OHC header on Application Summary and Application Details
...
#    Steps 3 & 4
  ...
  @SLER-1963
  Scenario: SLER-1963 I want changes to Health First Colorado information and see changes made to Health First Colorado information in the Application Summary
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 4
  ...
  @SLER-1964
  Scenario: SLER-1964 I want changes to my Health First Colorado information and see changes made to Health First Colorado information in the OBO Application Details
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 8
  ...
  @SLER-1965
  Scenario: SLER-1965 I want to show and hide changes for Health First Colorado information in the OBO Application Details Single Members
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 7
  ...
  @SLER-1966
  Scenario: SLER-1966 I want to verify OHC header on Application Summary and Application Details
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Steps 3 & 4
  ...
  @SLER-1967
  Scenario: SLER-1967 I want changes to CHP+ information and see changes made to CHP+ information in the Application Summary
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 4
  ...
  @SLER-1968
  Scenario: SLER-1968 I want changes to my CHP+ information and see changes made to CHP+ information in the OBO Application Details
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment
...
#    Step 8
  ...
  @SLER-1969
  Scenario: SLER-1969 I want to show and hide changes for CHP+ information in the OBO Application Details Single Members
    Then I click continue on family overview page
    Then I validate I am on the "Financial Help" page
    And I Apply for financial help
    Then I select the option "Yes" to employment

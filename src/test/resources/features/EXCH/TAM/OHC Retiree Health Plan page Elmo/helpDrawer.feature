...
Feature: Help Drawer-Other Health Coverage Page
  ...
  @SLER-908 @HelpDrawerRetireePage @TAMSmokeExch
  Scenario: SLER-908 Validate help drawer text on the Retiree page - English
    ...
    And I select "Help me understand" icon on the Retiree Page
    And I select "Please enter" icon on the Retiree Page
    Then I validate Retiree "full" help drawer verbiage in "English"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "Please enter" icon on the Retiree Page
    And I select "currently enrolled" icon on the Retiree Page
    Then I validate Retiree "currently enrolled" help drawer verbiage in "English"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "currently enrolled" icon on the Retiree Page
    And I select "60 days" icon on the Retiree Page
    Then I validate Retiree "60 days" help drawer verbiage in "English"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "60 days" icon on the Retiree Page
    And I select "voluntarily ending" icon on the Retiree Page
    Then I validate Retiree "voluntarily ending" help drawer verbiage in "English"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "voluntarily ending" icon on the Retiree Page
  ...
  Scenario: SLER-909 Validate help drawer text on the Retiree page - Spanish
    ...
    Then I click "Yes" for insurance ending in 60 days in Retiree question
    And I select "Help me understand" icon on the Retiree Page
    Then I validate Retiree "full" help drawer verbiage in "Spanish"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "Help me understand" icon on the Retiree Page
    And I select "Please enter" icon on the Retiree Page
    ...
    And I select "Please enter" icon on the Retiree Page
    And I select "currently enrolled" icon on the Retiree Page
    Then I validate Retiree "currently enrolled" help drawer verbiage in "Spanish"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "currently enrolled" icon on the Retiree Page
    And I select "60 days" icon on the Retiree Page
    Then I validate Retiree "60 days" help drawer verbiage in "Spanish"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "60 days" icon on the Retiree Page
    And I select "voluntarily ending" icon on the Retiree Page
    Then I validate Retiree "voluntarily ending" help drawer verbiage in "Spanish"
    And I click Retiree Contact Us link in help drawer footer
    And I validate I am on the "We Can Help" page and close tab
    And I select "voluntarily ending" icon on the Retiree Page

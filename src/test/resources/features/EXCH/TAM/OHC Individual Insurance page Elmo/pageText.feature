@TAM @TamExch
Feature: Page Text-OHC Individual Insurance Elmo Page
...
#    And I set the browser resolution to 1200 x 800
  ...
  @SLER-276 @PageTextOhcIndividualInsuranceElmo
  Scenario: SLER-276 I can see Individual Insurance's Header and footer - Spanish
    And I change the language from Elmo header to "Spanish" if it isn't already in that language
    And I verify the header for Primary Member on the Individual Insurance page in "Spanish"

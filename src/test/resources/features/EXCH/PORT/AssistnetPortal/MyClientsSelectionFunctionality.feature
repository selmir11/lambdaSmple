...
Feature: My Clients list client selection functionality in the AssistNet Portal
  ...
  Scenario: My Clients selection functionality
    ...
    When I login as Assistnet User any environment "carrimautomation+AssistersInc@gmail.com" password "ALaska24!" and "c4assistorportal+UT6JO3BqP@gmail.com" password "ALaska16!"

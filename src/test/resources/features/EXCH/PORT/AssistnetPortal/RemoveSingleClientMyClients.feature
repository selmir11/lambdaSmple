@AssistNet @port
Feature: Remove a single client from My Clients list in the AssistNet Portal

  @SLER-1779
  Scenario: Remove a single client from My Clients list
    ...
    Then I click "cancel" remove client

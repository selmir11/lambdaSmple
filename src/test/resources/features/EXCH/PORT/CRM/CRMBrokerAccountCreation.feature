@PortCRM @port
Feature: CRM validation following broker new account creation

  @SLER-2306
  Scenario: CRM validation following broker new account creation
    ...
    #Verifying broker account created in the CRM
    Then I log into the CRM system
    Then I search for "Broker" name
    And I wait for 2000 milliseconds
    Then I handle the search results page for "Broker"

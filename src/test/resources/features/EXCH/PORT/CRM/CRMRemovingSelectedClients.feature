@PortCRM @port
Feature: CRM validation following a selected client's deauthorization via Broker Portal

  @SLER-1816
  Scenario: CRM validation following a selected client's deauthorization via Broker Portal

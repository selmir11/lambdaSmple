@TransferRemove @port
Feature: Remove a client from the Review Transfer list

  @SLER-1777
  Scenario: Remove a client from the Review Transfer list
    ...
    Then I Search authorized Broker "TransferRemoveAg"
    ...
    #Agency owner removing a client from the transfer list
    Then I validate I am on the "Login" page
    ...
    Then I search for a broker named "TransferRemove" on the Agency Broker Transfer page
    And I validate the broker results match my broker named "TransferRemove One"
    ...
    Then I click "No" to removing the client from the transfer client list

    Then I click the Remove from Transfer link for the first client listed
    Then I click "Yes" to removing the client from the transfer client list

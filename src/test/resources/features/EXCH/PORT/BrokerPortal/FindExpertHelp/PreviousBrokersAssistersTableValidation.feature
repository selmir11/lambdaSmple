@FindExpertHelp @port
Feature: Tests the Previous Brokers/Assisters table on the Find expert help/Manage who helps you page

  @SLER-826
  Scenario: Verifies the Previous Brokers/Assisters table on the Find expert help/Manage who helps you page
    ...
    Then I validate the details in the Previous Broker Assister table are "Margie Kellogg", "159753456", "80205", "303-123-7895", "Broker"

...
Feature: Admin Portal user authorizing and deauthorizing a customer's broker which updates Broker Portal's client list
  ...
  @SLER-1802
  Scenario: Admin Portal user authorizing and deauthorizing a customer's broker which updates Broker Portal's client list
    ...
    #Associated broker verifying the client no longer displays in their client list
    Given I open the login page on the "broker" portal
    And I validate I am on the "Login" page
    And I login as Broker User any environment "C4PortTesting+PrestonSaunders@outlook.com" password "ALaska12!" and "C4PortTesting+PSaundersQA@outlook.com" password "ALaska12!"
    Then I open outlook Tab

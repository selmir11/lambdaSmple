...
Feature: Verify the Your Information page of Broker Portal
  ...
  @SLER-593
  Scenario: Verify the Your Information page for Admin Staff
    ...
    And I validate the First Name field shows my "Admin Staff" name
    And I validate the Last Name field shows my "Admin Staff" name
  ...
  @SLER-593
  Scenario: Verify the Your Information page for Brokers
    Given I open the login page on the "broker" portal
    And I validate I am on the "Login" page
    When I click create a new account on login page
    Then I validate I am on the "Create Account" page
    ...
    Then I validate the Your Information page title
    And I validate the First Name field shows my "Broker" name
    And I validate the Last Name field shows my "Broker" name

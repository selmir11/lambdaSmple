...
Feature: Trigger the exchange individual's notice for broker authorization in Spanish - BN-002A-03
  ...
  Scenario: Creating a new exchange individual account and authorizing the broker
    ...
    Then I enter general mandatory data for "exchange Spanish" account creation with email "C4PortTesting"@outlook.com
    ...
    And I verify the notice Text for "BN-002A-03" in "Spanish" for "Exch"

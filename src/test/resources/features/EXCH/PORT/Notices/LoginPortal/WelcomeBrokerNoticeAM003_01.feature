...
@SLER-1922
  Scenario: Broker Welcome notice AM-003-01
    ...
    And I enter mandatory data for "Broker" account creation with email "testing.soukaina"@outlook.com
    Then I validate I am on the "Login" page
    ...
    And I verify the notice Text for "AM-003-01" in "English" for "Broker"

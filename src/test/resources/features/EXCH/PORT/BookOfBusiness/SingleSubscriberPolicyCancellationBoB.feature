...
Feature: Broker Portal BOB - Single Subscriber NFA policy submission and medical policy cancellation

  @SLER-1024
  Scenario: : Single Subscriber NFA policy submission and enrollment

...
Feature: Broker Portal OBO - Single subscriber FA Application and enroll in a plan

  @SLER-1025
  Scenario: : Single subscriber FA application and enrollment
...
#Associated broker working OBO to submit an FA application and enroll in a plan

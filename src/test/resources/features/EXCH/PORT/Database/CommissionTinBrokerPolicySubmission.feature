@BrokerPortalDB @port
Feature: Agency commission TIN update for associated broker policy submission
  ...
  Scenario: : Individual account creation and broker authorization
    ...
    Then I Search authorized Broker "Mara Walton"
  ...
  #Associated broker submitting an NFA application and enrollment
    Given I open the login page on the "broker" portal
    And I validate I am on the "Login" page
    And I login as Broker User any environment "carrimautomation+MaraWaltonSTG@gmail.com" password "ALaska13!" and "carrimautomation+MaraWalton@gmail.com" password "ALaska13!"
    Then I open outlook Tab
    And I sign in to outlook with Valid Credentials "C4PortTesting@outlook.com" and "ALaska12!"
    Then I open the MFA notice
    And I get the MFA code

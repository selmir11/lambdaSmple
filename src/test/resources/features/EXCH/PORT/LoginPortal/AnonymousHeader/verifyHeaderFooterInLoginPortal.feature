...
Feature: Verify common header in Login Portal
  ...
  @SLER-783
  Scenario: Verify the common header and footer create account Page
    ...
    @SLER-784
  Scenario: Verify the common header and footer forgot password
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page
    ...
    @SLER-787
  Scenario: Verify the common header and footer forgot username
    Given I open the login page on the "login" portal
    And I validate I am on the "Login" page

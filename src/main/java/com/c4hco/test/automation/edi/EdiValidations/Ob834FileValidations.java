...
public class Ob834FileValidations {
    ...
    private void validateNM1SegNew(Member member, Ob834DetailsEntity entry) {
        List<List<String>> nm1Seg = member.getNM1();
        segCount = segCount + nm1Seg.size();
        MemberDetails memberFromSd =  basicActions.getMember(entry.getMember_first_name());
    ...
    private void getOb834MedEntityForSubscriber(String fileName) {
        List<Ob834DetailsEntity> medicalEntityList = SharedData.getOb834DetailsMedEntities();
    ...
    private void getOb834DenEntityForSubscriber(String fileName) {
        List<Ob834DetailsEntity> dentalEntityList = SharedData.getOb834DetailsDenEntities();

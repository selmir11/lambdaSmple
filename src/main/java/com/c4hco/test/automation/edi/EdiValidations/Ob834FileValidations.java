...
//        validateQtySeg();
    ...
    public void validateNM1Seg(Ob834DetailsEntity entry){
       ...
       if(SharedData.getPrimaryMember().getHasIncorrectEntities() !=null && SharedData.getPrimaryMember().getHasIncorrectEntities()){
           ...
           softAssert.assertNull(entry.getIncorrect_entity_type_qualifier(),"Incorrect entity type qualifier does not match");
           softAssert.assertNull(entry.getIncorrect_id_code_qualifier(),"Incorrect id code qualifier does not match");
           softAssert.assertNull(entry.getIncorrect_entity_id_code(),"Incorrect entity id code.");
           softAssert.assertNull(entry.getIncorrect_id_code(),"Incorrect id code");

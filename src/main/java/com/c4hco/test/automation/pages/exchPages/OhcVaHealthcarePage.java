...
public class OhcVaHealthcarePage {
    ...
    WebElement OhcVaHealthcareHeader;
    ...
    List<WebElement> VaHealthcareQuestionTxt;
    ...
    WebElement helpDrawerHeaderVaHealthcare;
...
// Add only validation methods below this line
    public void verifyHeadersVaHealthcareOhcPage(String language) {
        switch (language){
            case "English":
                verifyHeadersVaHealthcareOhcPageEnglish();
                break;
            case "Spanish":
                verifyHeadersVaHealthcareOhcPageSpanish();
                break;
            default:
    ...
    public void verifyVaHealthcarePageSecondSectionDataEnglish(){
        basicActions.waitForElementToBePresent(OhcHeader,15);
        softAssert.assertEquals(VaHealthcareQuestionTxt.get(1).getText(),"Will this health insurance end in the next 60 days?");
    ...
    public void verifyVaHealthcarePageThirdSectionDataEnglish(){
        basicActions.waitForElementToBePresent(OhcHeader,15);
        softAssert.assertEquals(VaHealthcareQuestionTxt.get(2).getText(),"What day will your coverage end?");
        softAssert.assertEquals(inputEndDate.getAttribute("placeholder"), "MM/DD/YYYY");
        softAssert.assertEquals(VaHealthcareQuestionTxt.get(3).getText(),"Are you voluntarily ending this health insurance?");
    ...
    public void verifyVaHealthcarePageFirstSectionDataSpanish(){
        ...
        softAssert.assertEquals(pleaseEnterTxt.getText(), "Ingrese la siguiente informaci\u00F3n acerca de su elegibilidad o inscripci\u00F3n actual en VA Health Care.");
        softAssert.assertEquals(VaHealthcareQuestionTxt.get(0).getText(),"\u00BFActualmente est\u00E1 inscrito en VA Health Care?");
    ...
    public void verifyVaHealthcarePageSecondSectionDataSpanish(){
        basicActions.waitForElementToBePresent(OhcHeader,15);
        softAssert.assertEquals(VaHealthcareQuestionTxt.get(1).getText(),"\u00BFEste seguro de salud terminar\u00E1 en los siguientes 60 d\u00EDas?");
    ...
    public void validateHelpVerbiage(String helpData,String language) {
        ...
        basicActions.waitForElementToBePresent(helpDrawerHeaderVaHealthcare, 30);
        switch (language) {
            case "English":
                switch (helpData){
                    case "full":
    ...
    public void validateGeneralHelpBodyVerbiageEng() {
        ...
        softAssert.assertEquals(helpDrawerHeaderVaHealthcare.getText(), "VA Healthcare");
    ...
    public void validateGeneralHelpBodyVerbiageSp() {
        ...
        softAssert.assertEquals(helpDrawerHeaderVaHealthcare.getText(), "Servicios de Salud para Veteranos (VA)");

            ...
            checkboxclick();
                switch (selectedOptionText) {
                    case "Exchange":
                        ...
                        break;
                    case "Individual":
                        List<String> IndExpectedList = List.of("IND_Health First Colorado (Medicaid) Application", "IND_Health First Colorado (Medicaid) Redetermination", "IND_Health First Colorado (Medicaid) Redetermination", "IND_Employer Application Form (ELG-005-01)", "IND_SSN Verification (ELG-002-01)", "IND_Incarceration Status (ELG-002-02)", "IND_SSAP with Financial Assistance Form (EN-002-01)", "IND_Individual Addendum Form (EN-002-02)", "IND_Individual Addendum Form (EN-002-02)", "IND_Employer Coverage Tool Form (EN-002-02)", "IND_SSAP Worksheet A (EN-002-04)", "IND_SSAP Worksheet B (EN-002-05)", "IND_SSAP Worksheet C (EN-002-06)", "IND_SSAP Worksheet D (EN-002-07)", "IND_Tribal Membership Verification (ELG-005-11)", "IND_Death Certificate (ELG-005-13)", "IND_Marriage Dissolution (ELG-005-14)", "IND_Legal Separation (ELG-005-15)", "IND_Employment Status Change (ELG-005-20)",

...
public class ImmigrationStatusPage {
    ...
    public void verifyImmigrationDropdownValues(List<String> dropDownText) {
        ...
        String actualDropdownText = immigrationStatusLPRNo.getText();
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(0)), "Administrative order staying removal is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(1)), "Afghan or Iraqi Special Immigrant Visa (SIV) holder is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(2)), "Afghan or Ukrainian Humanitarian Parolee is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(3)), "Applicant for adjustment to LPR status is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(4)), "Applicant for asylum is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(5)), "Applicant for Cancellation of Removal or Suspension of Deportation is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(6)), "Applicant for legalization under the Immigration Reform and Control Act is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(7)), "Applicant for Legalization under the LIFE Act is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(8)), "Applicant/recipient for Temporary Protected Status is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(9)), "Applicant for withholding of deportation or removal is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(10)), "Citizen of Micronesia, the Marshall Islands, or Palau is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(11)), "Conditional Entrant Granted before 1980 is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(12)), "Cuban/Haitian Entrant is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(13)), "Deferred Action Status (including DACA) is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(14)), "Deferred Enforced Departure is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(15)), "Granted Withholding of Deportation is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(16)), "Native American born in Canada is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(17)), "Non-immigrant visa holder is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(18)), "Order of Supervision is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(19)), "Paroled into the U.S. is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(20)), "Refugee or asylee is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(21)), "Registry applicant is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(22)), "Resident of American Samoa is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(23)), "Temporary Protected Status is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(24)), "Temporary Resident Status is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(25)), "Victim of battery/abuse (or victim's spouse, child, or parent) is not present");
        softAssert.assertTrue(actualDropdownText.contains(dropDownText.get(26)), "Victim of trafficking (or victim's spouse, child, sibling or parent) is not present");
        softAssert.assertAll();
    }

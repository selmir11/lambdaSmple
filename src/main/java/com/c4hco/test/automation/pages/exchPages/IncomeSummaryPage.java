...
public class IncomeSummaryPage {
    ...
    public void validateGeneralHelpBodyVerbiageEng() {
        ...
        softAssert.assertEquals(helpDrawerNewHeaders.get(1).getText(), "Projected Income");
    ...
    public void validateGeneralHelpBodyVerbiageSp() {
        ...
        softAssert.assertEquals(helpDrawerNewHeaders.get(1).getText(), "Ingresos que proyecta");

...
public class OhcTricarePage {
    ...
    WebElement helpDrawerHeaderTricare;
    ...
    public void verifyHeadersTricareOhcPage(String language){
        switch (language) {
            case "English":
                verifyHeadersTricareOhcPageEnglish();
                break;
            case "Spanish":
                verifyHeadersTricareOhcPageSpanish();
                break;
            default:
    ...
    public void validateHelpVerbiage(String helpData,String language) {
        ...
        basicActions.waitForElementToBePresent(helpDrawerHeaderTricare, 30);
        switch (language) {
            case "English":
                switch (helpData){
                    case "full":
    ...
    public void validateGeneralHelpBodyVerbiageEng() {
        ...
        softAssert.assertEquals(helpDrawerHeaderTricare.getText(), "TRICARE");

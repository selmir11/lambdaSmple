...
public class OhcCobraPage {
    ...
    WebElement helpDrawerHeaderCobra;
    ...
    WebElement helpDrawerEnrollmentHeader;

    @FindBy(css = "div.desktop-help > mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > strong:nth-child(7)")
    WebElement helpDrawer60DayHeader;

    @FindBy(css = "div.desktop-help > mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > strong:nth-child(10)")
    WebElement helpDrawerVoluntarilyHeader;

    @FindBy(css = ".drawer-text-content > div > div")
    List<WebElement> helpDrawerBodyParagraphs;

    @FindBy(css = "mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > p:nth-child(3)")
    WebElement helpDrawerBodyParagraph1;

    @FindBy(css = "mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > p:nth-child(6)")
    WebElement helpDrawerBodyParagraph2;

    @FindBy(css = "mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > p:nth-child(9)")
    WebElement helpDrawerBodyParagraph3;

    @FindBy(css = "mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > p:nth-child(12)")
    WebElement helpDrawerBodyParagraph4;
    ...
    public void verifyHeadersCobraOhcPage(String language){
        switch (language){
            case "English":
                verifyHeadersCobraOhcPageEnglish();
                break;
            case "Spanish":
                verifyHeadersCobraOhcPageSpanish();
                break;
            default:
    ...
    public void verifyEndDate(){
        ...
        lastDayOfMonth = basicActions.changeDateFormat(lastDayOfMonth, "MM-dd-yyyy", "yyyy-MM-dd");
        softAssert.assertTrue(inputEndDate.getAttribute("value").contains(lastDayOfMonth));
        softAssert.assertAll();
    }
    ...
    public void verifyCobraPageFirstSectionSecondaryDataEnglish(){
        ...
        softAssert.assertEquals(OhcCobraHeader.getText(),"COBRA");
        softAssert.assertEquals(helpMeLink.getText(),"Help me understand this page");
        softAssert.assertTrue(pleaseEnterTxt.getText().equalsIgnoreCase( "Please enter the following information about " + SharedData.getMembers().get(0).getFullName() + "'s eligibility or current enrollment in COBRA coverage"));
        softAssert.assertTrue(CobraQuestionTxt.get(0).getText().equalsIgnoreCase("Is " + SharedData.getMembers().get(0).getFullName() + " currently enrolled in COBRA coverage?"));
        softAssert.assertEquals(currentlyEnrolledYes.getText(),"Yes");
        softAssert.assertEquals(currentlyEnrolledNo.getText(),"No");
        softAssert.assertAll();
    }
    ...
    public void verifyCobraPageThirdSectionSecondaryDataEnglish(){
        ...
        softAssert.assertEquals(inputEndDate.getAttribute("placeholder"), "MM/DD/YYYY");
        softAssert.assertTrue(CobraQuestionTxt.get(3).getText().equalsIgnoreCase("Is " + SharedData.getMembers().get(0).getFullName() + " voluntarily ending this health insurance?"));
        softAssert.assertEquals(endVoluntaryYes.getText(),"Yes");
        softAssert.assertEquals(endVoluntaryNo.getText(),"No");
        softAssert.assertAll();
    }
    ...
    public void verifyCobraPageDataSpanish(String dataToVerify){
        ...
        switch (dataToVerify){
            ...
            case "Third Section":
                ...
                break;
            case "First Section Secondary":
                verifyCobraPageFirstSectionSecondaryDataSpanish();
                break;
            case "Second Section Secondary":
                verifyCobraPageFirstSectionSecondaryDataSpanish();
                verifyCobraPageSecondSectionDataSpanish();
            ...
            case "Third Section Secondary":
                verifyCobraPageFirstSectionSecondaryDataSpanish();
                verifyCobraPageSecondSectionDataSpanish();
                verifyCobraPageThirdSectionSecondaryDataSpanish();
                break;
            default:
                throw new IllegalArgumentException("Invalid option: " + dataToVerify);
        }
    ...
    public void verifyCobraPageFirstSectionDataSpanish(){
        ...
        softAssert.assertEquals(pleaseEnterTxt.getText(), "Ingrese la siguiente informaci\u00F3n acerca de su elegibilidad o inscripci\u00F3n actual en la cobertura COBRA.");
        softAssert.assertEquals(CobraQuestionTxt.get(0).getText(),"\u00BFActualmente est\u00E1 inscrito en la cobertura COBRA?");
    ...
    public void verifyCobraPageSecondSectionDataSpanish(){
        basicActions.waitForElementToBePresent(OhcHeader,15);
        softAssert.assertEquals(CobraQuestionTxt.get(1).getText(),"\u00BFEste seguro de salud terminar\u00E1 en los siguientes 60 d\u00EDas?");
    ...
    public void verifyCobraPageThirdSectionDataSpanish(){
        basicActions.waitForElementToBePresent(OhcHeader,15);
        softAssert.assertEquals(CobraQuestionTxt.get(2).getText(),"\u00BFQu\u00E9 d\u00EDa termina su cobertura?");
        softAssert.assertEquals(inputEndDate.getAttribute("placeholder"), "MM/DD/YYYY");
        softAssert.assertEquals(CobraQuestionTxt.get(3).getText(),"\u00BFEst\u00E1 cancelando voluntariamente este seguro de salud?");
    ...
    public void verifyCobraPageFirstSectionSecondaryDataSpanish(){
        ...
        softAssert.assertEquals(OhcCobraHeader.getText(),"COBRA");
        softAssert.assertEquals(helpMeLink.getText(),"Ayuda para entender esta p\u00E1gina");
        softAssert.assertTrue(pleaseEnterTxt.getText().equalsIgnoreCase( "Ingrese la siguiente informaci\u00F3n acerca de la elegibilidad o inscripci\u00F3n actual de " + SharedData.getMembers().get(0).getFullName() + " en la cobertura COBRA."));
        softAssert.assertTrue(CobraQuestionTxt.get(0).getText().equalsIgnoreCase("\u00BFActualmente " + SharedData.getMembers().get(0).getFullName() + " est\u00E1 inscrito en la cobertura COBRA?"));
        softAssert.assertEquals(currentlyEnrolledYes.getText(),"S\u00ED");
        softAssert.assertEquals(currentlyEnrolledNo.getText(),"No");
        softAssert.assertAll();
    }

    public void verifyCobraPageThirdSectionSecondaryDataSpanish(){
        basicActions.waitForElementToBePresent(OhcHeader,15);
        softAssert.assertTrue(CobraQuestionTxt.get(2).getText().equalsIgnoreCase("\u00BFQu\u00E9 d\u00EDa termina la cobertura de " + SharedData.getMembers().get(0).getFullName() + "?"));
        softAssert.assertEquals(inputEndDate.getAttribute("placeholder"), "MM/DD/YYYY");
        softAssert.assertTrue(CobraQuestionTxt.get(3).getText().equalsIgnoreCase("\u00BF" + SharedData.getMembers().get(0).getFullName() + " est\u00E1 cancelando voluntariamente este seguro de salud?"));
        softAssert.assertEquals(endVoluntaryYes.getText(),"S\u00ED");
        softAssert.assertEquals(endVoluntaryNo.getText(),"No");
        softAssert.assertAll();
    }
    ...
    public void validateHelpVerbiage(String helpData,String language) {
        ...
        basicActions.waitForElementToBePresent(helpDrawerHeaderCobra, 30);
        switch (language) {
            case "English":
                switch (helpData){
                    case "full":
    ...
    public void validateGeneralHelpBodyVerbiageEng() {
        ...
        softAssert.assertEquals(helpDrawerHeaderCobra.getText(), "COBRA");
        softAssert.assertEquals(helpDrawerOverviewHeader.getText(), "Overview");
        softAssert.assertEquals(helpDrawerEnrollmentHeader.getText(), "Enrollment");
        softAssert.assertEquals(helpDrawer60DayHeader.getText(), "End in the next 60 days");
        softAssert.assertEquals(helpDrawerVoluntarilyHeader.getText(), "Voluntarily Ending");
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "This page helps us find out if this person is enrolled in or eligible for other health insurance. By eligible, we mean that they have the option to enroll, even if they aren't currently enrolled.");
        softAssert.assertEquals(helpDrawerBodyParagraph2.getText(), "If this person currently has this health insurance, select \"Yes\". If they are able to get this health insurance, but have chosen not to, select \"No\".");
        softAssert.assertEquals(helpDrawerBodyParagraph3.getText(), "If this insurance is ending in the next 60 days, this person is eligible for a Special Enrollment Period which allows you and your family to shop for health insurance outside of the Open Enrollment Period.");
        softAssert.assertEquals(helpDrawerBodyParagraph4.getText(), "If this person chooses to end this health insurance, they will not be eligible for a Special Enrollment Period to shop for other health insurance. They must wait until the next Open Enrollment Period to shop unless they have another qualifying life change event.");
    ...
    public void validateGeneralHelpBodyVerbiageSp() {
        ...
        softAssert.assertEquals(helpDrawerEnrollmentHeader.getText(), "Inscripci\u00F3n");
        softAssert.assertEquals(helpDrawer60DayHeader.getText(), "Finalizaci\u00F3n en los pr\u00F3ximos 60 d\u00EDas");
        softAssert.assertEquals(helpDrawerVoluntarilyHeader.getText(), "Cancelaci\u00F3n voluntaria");
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "Esta p\u00E1gina nos ayuda a saber si esta persona est\u00E1 inscrita o es elegible para otro seguro de salud. Al decir elegible, nos referimos a que tiene la opci\u00F3n de inscribirse, aun si la persona no est\u00E1 actualmente inscrita.");
        softAssert.assertEquals(helpDrawerBodyParagraph2.getText(), "Si actualmente esta persona tiene este seguro de salud, seleccione \"S\u00ED\". Si esta persona puede obtener este seguro de salud, pero ha decidido no tenerlo, seleccione \"No\".");
        softAssert.assertEquals(helpDrawerBodyParagraph3.getText(), "Si este seguro va a terminar en los pr\u00F3ximos 60 d\u00EDas, esta persona es elegible para un Per\u00EDodo de inscripci\u00F3n especial que le permite tanto a usted como a su familia adquirir un seguro de salud fuera del Per\u00EDodo de inscripci\u00F3n abierta.");
        softAssert.assertEquals(helpDrawerBodyParagraph4.getText(), "Si esta persona decide cancelar este seguro de salud, no podr\u00E1 ser elegible para un Per\u00EDodo de inscripci\u00F3n especial para adquirir otro seguro de salud. Deber\u00E1 esperar hasta el siguiente Per\u00EDodo de inscripci\u00F3n abierta para adquirirlo a menos que tenga otro evento de vida calificado.");
    ...
    public void validateCurrentlyEnrolledHelpBodyVerbiageEng() {
        ...
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "If this person currently has this health insurance, select \"Yes\". If they are able to get this health insurance, but have chosen not to, select \"No\".");
        softAssert.assertEquals(helpDrawerFooter.getText(), "Need more help?\nContact us");
        softAssert.assertAll();
    }
    ...
    public void validateCurrentlyEnrolledHelpBodyVerbiageSp() {
        ...
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "Si actualmente esta persona tiene este seguro de salud, seleccione \"S\u00ED\". Si esta persona puede obtener este seguro de salud, pero ha decidido no tenerlo, seleccione \"No\".");
        softAssert.assertEquals(helpDrawerFooter.getText(), "\u00BFNecesitas m\u00E1s ayuda?\nCont\u00E1ctenos");
        softAssert.assertAll();
    }
    ...
    public void validate60DaysHelpBodyVerbiageEng() {
        ...
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "If this insurance is ending in the next 60 days, this person is eligible for a Special Enrollment Period which allows you and your family to shop for health insurance outside of the Open Enrollment Period.");
        softAssert.assertEquals(helpDrawerFooter.getText(), "Need more help?\nContact us");
        softAssert.assertAll();
    }
    ...
    public void validate60DaysHelpBodyVerbiageSp() {
        ...
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "Si este seguro va a terminar en los pr\u00F3ximos 60 d\u00EDas, esta persona es elegible para un Per\u00EDodo de inscripci\u00F3n especial que le permite tanto a usted como a su familia adquirir un seguro de salud fuera del Per\u00EDodo de inscripci\u00F3n abierta.");
        softAssert.assertEquals(helpDrawerFooter.getText(), "\u00BFNecesitas m\u00E1s ayuda?\nCont\u00E1ctenos");
        softAssert.assertAll();
    }
    ...
    public void validateVoluntaryEndingHelpBodyVerbiageEng() {
        ...
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "If this person chooses to end this health insurance, they will not be eligible for a Special Enrollment Period to shop for other health insurance. They must wait until the next Open Enrollment Period to shop unless they have another qualifying life change event.");
        softAssert.assertEquals(helpDrawerFooter.getText(), "Need more help?\nContact us");
        softAssert.assertAll();
    }
    ...
    public void validateVoluntaryEndingHelpBodyVerbiageSp() {
        ...
        softAssert.assertEquals(helpDrawerBodyParagraph1.getText(), "Si esta persona decide cancelar este seguro de salud, no podr\u00E1 ser elegible para un Per\u00EDodo de inscripci\u00F3n especial para adquirir otro seguro de salud. Deber\u00E1 esperar hasta el siguiente Per\u00EDodo de inscripci\u00F3n abierta para adquirirlo a menos que tenga otro evento de vida calificado.");
        softAssert.assertEquals(helpDrawerFooter.getText(), "\u00BFNecesitas m\u00E1s ayuda?\nCont\u00E1ctenos");
        softAssert.assertAll();
    }

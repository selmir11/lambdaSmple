...
public class OhcRetireeHealthPlanPage {
    ...
    @FindBy(css = "div > div.desktop-help > mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > strong:nth-child(1)")
    WebElement helpDrawerHeaderOne;

    @FindBy(css = "div > div.desktop-help > mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > strong:nth-child(4)")
    WebElement helpDrawerHeaderTwo;

    @FindBy(css = "div > div.desktop-help > mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > strong:nth-child(7)")
    WebElement helpDrawerHeaderThree;

    @FindBy(css = "div > div.desktop-help > mat-dialog-content > div > div > div.help-main-content.ng-star-inserted > strong:nth-child(10)")

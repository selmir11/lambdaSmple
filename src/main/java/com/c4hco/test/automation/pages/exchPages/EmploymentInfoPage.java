...
public class EmploymentInfoPage {
    ...
    public void verifyTextOnInitialIncomePage(String language,List<String> dataText) {
        switch (language) {
            case "English":
                verifyTextOnInitialIncomePageEnglish(dataText);
                break;
            case "Spanish":
                verifyTextOnInitialIncomePageSpanish(dataText);
                break;
            default:
                throw new IllegalArgumentException("Invalid option: " +language );
        }
    ...
    public void verifyTextOnIncomePageAfterClickingYesToEmploymentQuestion(String language,List<String> dataText) {
        switch (language) {
            case "English":
                verifyTextAfterClickingYesToEmploymentQuestionEnglish(dataText);
                break;
            case "Spanish":
                verifyTextAfterClickingYesToEmploymentQuestionSpanish(dataText);
                break;
            default:
                throw new IllegalArgumentException("Invalid option: " +language );
        }
    ...
    public void verifyTextOnInitialIncomePageEnglish(List<String> dataText){
    ...
    public void verifyTextOnInitialIncomePageSpanish(List<String> dataText){
        basicActions.waitForElementToBePresent(txtHeaderPart1, 10);
        basicActions.waitForElementToBePresent(txtHeaderPart2, 10);
        basicActions.waitForElementToBePresent(haveAJobOrEmployedQuestion, 10);
        basicActions.waitForElementToBePresent(goBackButton, 10);
    ...
    public void verifyTextAfterClickingYesToEmploymentQuestionEnglish(List<String> dataText){
        basicActions.waitForElementToBePresent(txtHeaderPart1, 10);
        basicActions.waitForElementToBePresent(txtHeaderPart2, 10);
        basicActions.waitForElementToBePresent(haveAJobOrEmployedQuestion, 10);
        basicActions.waitForElementToBePresent(goBackButton, 10);
    ...
    public void verifyTextAfterClickingYesToEmploymentQuestionSpanish(List<String> dataText){
        basicActions.waitForElementToBePresent(txtHeaderPart1, 10);
        basicActions.waitForElementToBePresent(txtHeaderPart2, 10);
        basicActions.waitForElementToBePresent(haveAJobOrEmployedQuestion, 10);
        basicActions.waitForElementToBePresent(goBackButton, 10);
    ...
    public void verifyTextOnIncomePageAfterClickingYesToSelfEmploymentQuestion(String language,List<String> dataText) {
        switch (language) {
            case "English":
                verifyTextAfterClickingYesToSelfEmploymentQuestionEnglish(dataText);
                break;
            case "Spanish":
                verifyTextAfterClickingYesToSelfEmploymentQuestionSpanish(dataText);
                break;
            default:
                throw new IllegalArgumentException("Invalid option: " +language );
        }
    ...
    public void verifyTextAfterClickingYesToSelfEmploymentQuestionEnglish(List<String> dataText){
        basicActions.waitForElementToBePresent(txtHeaderPart1, 10);
        basicActions.waitForElementToBePresent(txtHeaderPart2, 10);
        basicActions.waitForElementToBePresent(haveAJobOrEmployedQuestion, 10);
        basicActions.waitForElementToBePresent(goBackButton, 10);
    ...
    public void verifyTextAfterClickingYesToSelfEmploymentQuestionSpanish(List<String> dataText){
        basicActions.waitForElementToBePresent(txtHeaderPart1, 10);
        basicActions.waitForElementToBePresent(txtHeaderPart2, 10);
        basicActions.waitForElementToBePresent(haveAJobOrEmployedQuestion, 10);
        basicActions.waitForElementToBePresent(goBackButton, 10);
        ...
        softAssert.assertEquals(selectOptionLabel.getText(), dataText.get(15), "Select Option Label not matching");
        softAssert.assertEquals(incomeSameLowerNextYearQuestionWhenYesToSelfEmployedQuestion.getText(), dataText.get(16), "Income same or Lower question not matching");
        softAssert.assertEquals(btnIncomeSameYes.getText().trim(), dataText.get(17), "Yes button label for Income Same question not matching");
        softAssert.assertEquals(btnIncomeSameNo.getText(), dataText.get(18), "No button label for Income Same question not matching");
        softAssert.assertAll();
    }

    public void verifyTextOnIncomePageAfterClickingNoToSelfEmploymentQuestion(String language,List<String> dataText) {
        switch (language) {
            case "English":
                verifyTextAfterClickingNoToSelfEmploymentQuestionEnglish(dataText);
                break;
            case "Spanish":
                verifyTextAfterClickingNoToSelfEmploymentQuestionSpanish(dataText);
                break;
            default:
                throw new IllegalArgumentException("Invalid option: " +language );
        }
    ...
    public void verifyTextAfterClickingNoToSelfEmploymentQuestionEnglish(List<String> dataText){
        basicActions.waitForElementToBePresent(txtHeaderPart1, 10);
        basicActions.waitForElementToBePresent(txtHeaderPart2, 10);
        basicActions.waitForElementToBePresent(haveAJobOrEmployedQuestion, 10);
        basicActions.waitForElementToBePresent(goBackButton, 10);
    ...
    public void verifyTextAfterClickingNoToSelfEmploymentQuestionSpanish(List<String> dataText){
        basicActions.waitForElementToBePresent(txtHeaderPart1, 10);
        basicActions.waitForElementToBePresent(txtHeaderPart2, 10);
        basicActions.waitForElementToBePresent(haveAJobOrEmployedQuestion, 10);
        basicActions.waitForElementToBePresent(goBackButton, 10);

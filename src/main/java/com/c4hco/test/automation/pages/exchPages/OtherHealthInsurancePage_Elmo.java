...
public class OtherHealthInsurancePage_Elmo {
    ...
    public void verifyTextOnOtherHealthInsurancePage(String language){
        switch(language){
            ...
            case "English Secondary":
                verifyTextOnOtherHealthInsurancePageEnglishSecondary();
                break;
            case "Spanish":
                verifyTextOnOtherHealthInsurancePageSpanish();
                break;
            case "Spanish Secondary":
                verifyTextOnOtherHealthInsurancePageSpanishSecondary();
                break;
            default:
    ...
    public void verifyTextOnOtherHealthInsurancePageEnglishSecondary(){
        basicActions.waitForElementToBePresent(existingHealthInsuranceHeader,15);
    ...
    public void verifyTextOnOtherHealthInsurancePageSpanishSecondary(){
        basicActions.waitForElementToBePresent(existingHealthInsuranceHeader,15);

...
public class OtherHealthInsurancePage_Elmo {
    ...
    public void verifyTextOnOtherHealthInsurancePageSpanish(){
        basicActions.waitForElementToBePresent(existingHealthInsuranceHeader,15);
        softAssert.assertTrue(existingHealthInsuranceHeader.getText().equalsIgnoreCase("Other Health Coverage: " + SharedData.getPrimaryMember().getFirstName() + " " + SharedData.getPrimaryMember().getLastName()+" (Spanish)"));
        softAssert.assertEquals(existingHealthInsuranceHeader.getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsuranceHeader.getCssValue("font-size"), "36px");
        softAssert.assertEquals(existingHealthInsuranceHeader.getCssValue("font-weight"), "700");
        softAssert.assertEquals(existingHealthInsuranceHeader.getCssValue("color"), "rgba(77, 77, 79, 1)");
        ...
        softAssert.assertEquals(helpLink.getCssValue("font-weight"), "700");
        softAssert.assertEquals(helpLink.getCssValue("color"), "rgba(26, 112, 179, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt1.get(0).getText(), "Are you currently enrolled in or eligible to receive any of the following types of health coverage? (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt1.get(0).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt1.get(0).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt1.get(0).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt1.get(0).getCssValue("color"), "rgba(77, 77, 79, 1)");
        ...
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(0).getCssValue("font-weight"), "700");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(0).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(1).getText(), "Health First Colorado (Colorado\u2019s Medicaid Program) (spanish)\nIf your Health First Colorado coverage is ending in the next 60 days, do not select this option (spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(1).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(1).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(1).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(1).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(2).getText(), "Child Health Plan Plus (CHP+) (spanish)\nIf your CHP+ coverage is ending in the next 60 days, do not select this option (spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(2).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(2).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(2).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(2).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(3).getText(), "Medicare (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(3).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(3).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(3).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(3).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(4).getText(), "Coverage through an Employer (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(4).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(4).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(4).getCssValue("font-weight"), "700");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(4).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(5).getText(), "Health insurance offered through a job(Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(5).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(5).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(5).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(5).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(6).getText(), "Health Reimbursement Arrangement (HRA) (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(6).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(6).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(6).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(6).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(7).getText(), "Retiree Health Plan (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(7).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(7).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(7).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(7).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(8).getText(), "Peace Corp (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(8).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(8).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(8).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(8).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(9).getText(), "COBRA (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(9).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(9).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(9).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(9).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(10).getText(), "Coverage through the Military (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(10).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(10).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(10).getCssValue("font-weight"), "700");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(10).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(11).getText(), "VA Health Care (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(11).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(11).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(11).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(11).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(12).getText(), "TRICARE (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(12).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(12).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(12).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(12).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(13).getText(), "Individual Insurance (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(13).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(13).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(13).getCssValue("font-weight"), "700");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(13).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(14).getText(), "Health insurance purchased directly through an insurance company, through HealthCare.gov, or another state\u2019s Marketplace. (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(14).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(14).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(14).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(14).getCssValue("color"), "rgba(77, 77, 79, 1)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(16).getText(), "None of these (Spanish)");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(16).getCssValue("font-family"), "\"PT Sans\", sans-serif");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(16).getCssValue("font-size"), "16px");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(16).getCssValue("font-weight"), "400");
        softAssert.assertEquals(existingHealthInsurancePageTxt2.get(16).getCssValue("color"), "rgba(77, 77, 79, 1)");
    ...
    public void verifyOhiPageData(String language){
        ...
        switch (language){
            case "English":
                ...
                break;
            case "Spanish":
                softAssert.assertTrue(existingHealthInsuranceHeader.getText().equalsIgnoreCase("Other Health Coverage: " + SharedData.getPrimaryMember().getFullName() + " (Spanish)"));
                softAssert.assertEquals(helpLink.getText(),"Help me understand this page");
                softAssert.assertEquals(existingHealthInsurancePageTxt1.get(0).getText(),"Are you currently enrolled in or eligible to receive any of the following types of health coverage? (Spanish)");
                softAssert.assertEquals(existingHealthInsurancePageTxt1.get(1).getText(),"(Select all that apply) (Spanish)");
                softAssert.assertEquals(existingHealthInsurancePageTxt2.get(0).getText(),"Insurance through State of Colorado (Spanish)");
    ...
    public void verifyHelpDrawerHeaderText(String language) {
        ...
        switch (language) {
            case "English":
                ...
                softAssert.assertEquals(helpDrawerHeader.get(0).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerHeader.get(0).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerHeader.get(0).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerHeader.get(0).getCssValue("color"), "rgba(77, 77, 79, 1)");
    ...
    public void verifyHelpDrawerHeaderBody(String language) {
        ...
        switch (language) {
            case "English":
                ...
                softAssert.assertEquals(helpDrawerBody.get(0).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(0).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(0).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(0).getCssValue("color"), "rgba(77, 77, 79, 1)");
                ...
                softAssert.assertEquals(helpDrawerBody.get(1).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(1).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(1).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(1).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(2).getText(), "Health First Colorado (Colorado's Medicaid program)");
                softAssert.assertEquals(helpDrawerBody.get(2).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(2).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(2).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(2).getCssValue("color"), "rgba(77, 77, 79, 1)");
                ...
                softAssert.assertEquals(helpDrawerBody.get(4).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(4).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(4).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(4).getCssValue("color"), "rgba(77, 77, 79, 1)");
                ...
                softAssert.assertEquals(helpDrawerBody.get(3).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(3).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(3).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(3).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(5).getText(), "Child Health Plan Plus (CHP+)");
                softAssert.assertEquals(helpDrawerBody.get(5).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(5).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(5).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(5).getCssValue("color"), "rgba(77, 77, 79, 1)");
                ...
                softAssert.assertEquals(helpDrawerBody.get(7).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(7).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(7).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(7).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(6).getText(), "If you will lose eligibility for this program, do not select this option. Instead, select \"None of these apply\" and click \"Save and Continue.\"\n" +
                ...
                softAssert.assertEquals(helpDrawerBody.get(6).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(6).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(6).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(6).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(8).getText(), "Medicare");
                softAssert.assertEquals(helpDrawerBody.get(8).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(8).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(8).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(8).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(9).getText(), "This is the national health insurance program for people age 65 or older, or who have a disability determined by the Social Security Administration.");
                softAssert.assertEquals(helpDrawerBody.get(9).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(9).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(9).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(9).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(10).getText(), "Employer Sponsored Health Insurance");
                softAssert.assertEquals(helpDrawerBody.get(10).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(10).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(10).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(10).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(11).getText(), "This is health insurance through a job or a spouse's job. If you are currently in a waiting period for your employer-sponsored health insurance to begin (meaning that your employer has offered coverage to you or your dependent, but the coverage will be effective later), you may be eligible for a Premium Tax Credit during that waiting period. If you are currently in a waiting period, you should not check the box here. Instead, you should come back just before your waiting period is over to report your upcoming enrollment in employer-sponsored insurance. To avoid duplicate coverage and overlapping monthly premium charges for both plans, you must report your employer insurance change in your Connect for Health Colorado account as soon as possible \u2013 ideally, in the month before your coverage begins.");
                softAssert.assertEquals(helpDrawerBody.get(11).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(11).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(11).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(11).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(12).getText(), "Employer Sponsored Health Reimbursement Arrangement");
                softAssert.assertEquals(helpDrawerBody.get(12).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(12).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(12).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(12).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(13).getText(), "Select this option if your employer offers you a Health Reimbursement Arrangement (HRA) to help you pay for health insurance, even if you do not sign up for it. The HRA option that your employer offers may be called a Qualified Small Employer HRA (QSEHRA) or an Individual Coverage HRA (ICHRA).");
                softAssert.assertEquals(helpDrawerBody.get(13).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(13).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(13).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(13).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(14).getText(), "Retiree Health Plan");
                softAssert.assertEquals(helpDrawerBody.get(14).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(14).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(14).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(14).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(15).getText(), "This is the health insurance option for people who have retired from their job.");
                softAssert.assertEquals(helpDrawerBody.get(15).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(15).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(15).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(15).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(16).getText(), "Peace Corps");
                softAssert.assertEquals(helpDrawerBody.get(16).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(16).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(16).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(16).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(17).getText(), "This is a health insurance program for former Peace Corps volunteers.");
                softAssert.assertEquals(helpDrawerBody.get(17).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(17).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(17).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(17).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(18).getText(), "COBRA");
                softAssert.assertEquals(helpDrawerBody.get(18).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(18).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(18).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(18).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(19).getText(), "This is the health insurance option for people after they've left their job with employer-sponsored health insurance.");
                softAssert.assertEquals(helpDrawerBody.get(19).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(19).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(19).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(19).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(20).getText(), "Veteran's (VA) Healthcare");
                softAssert.assertEquals(helpDrawerBody.get(20).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(20).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(20).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(20).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(21).getText(), "This is the national health insurance program for qualified veterans of the military.");
                softAssert.assertEquals(helpDrawerBody.get(21).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(21).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(21).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(21).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(22).getText(), "TRICARE");
                softAssert.assertEquals(helpDrawerBody.get(22).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(22).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(22).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(22).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(23).getText(), "This is a health care program of the United States Department of Defense Military Health System.");
                softAssert.assertEquals(helpDrawerBody.get(23).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(23).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(23).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(23).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(24).getText(), "Individual Insurance (outside of Marketplace)");
                softAssert.assertEquals(helpDrawerBody.get(24).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(24).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(24).getCssValue("font-weight"), "700");
                softAssert.assertEquals(helpDrawerBody.get(24).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertEquals(helpDrawerBody.get(25).getText(), "This is health private insurance that you currently have that you did not get through Connect for Health Colorado or your job.");
                softAssert.assertEquals(helpDrawerBody.get(25).getCssValue("font-family"), "\"PT Sans\", sans-serif");
                softAssert.assertEquals(helpDrawerBody.get(25).getCssValue("font-size"), "16px");
                softAssert.assertEquals(helpDrawerBody.get(25).getCssValue("font-weight"), "400");
                softAssert.assertEquals(helpDrawerBody.get(25).getCssValue("color"), "rgba(77, 77, 79, 1)");
                softAssert.assertAll();
                break;
            case "Spanish":

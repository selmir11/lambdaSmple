...
public class Ob834PreEdiDbValidations {
    ...
    private void validateDependentMedDetails(Ob834DetailsEntity ob834Entity){
        ...
        for(MemberDetails member: members){
            if(member.getFirstName().equals(ob834Entity.getMember_first_name())){
               ...
               // softAssert.assertEquals(medicalDbData.getPremiumAmt(), ob834Entity.getPremium_amount(), "Member Medical Plan premium amount does not match for subscriber.");
    ...
    private void validateMedForSubscriberAndMem(Ob834DetailsEntity ob834Entity, MemberDetails member){
        ...
        validateResidentialAddress(ob834Entity, member);
        validateMailingAddress(ob834Entity, member);
        softAssert.assertAll();
    }
    ...
    private void validateDentalAPTCAmount(Ob834DetailsEntity ob834Entity) {
        softAssert.assertEquals(ob834Entity.getPremium_reduction_amt(), "0.00", "Dental Plan premium reduction amount does not match");

...
public class COCO_Ob834_Grp_PreEdiDbValidations {
    ...
    public void grpsRecordsValidations(List<Map<String, String>> expectedValues) {
        setData();
...
//  Bug NVO-5231  softAssert.assertEquals(ob834Entity.getMarital_status_code(), "I", "Marital Status did not match for "+member.getFirstName());
    ...
    private void medDenValidationsCommonForAllMem(Ob834DetailsEntity ob834Entity, MemberDetails member) {
        ...
        softAssert.assertTrue(dbDataMap.get(name).getRatingAreaName().contains(ob834Entity.getRate_area()), "Rate Area name mismatch");
    ...
    private String getTotalEnrollees(Ob834DetailsEntity ob834DetailsEntity) {
        return basicActions.getTotalMedEnrollees(ob834DetailsEntity.getMember_first_name());
    }

    private String getGrpNum(Ob834DetailsEntity ob834DetailsEntity) {
        return getMemberMedGrp(ob834DetailsEntity.getMember_first_name());
    }

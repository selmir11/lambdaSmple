...
public class DbQueries_Exch {
    ...
    public String policyTablesQuery() {
        ...
        return "select eph.account_id, eph.application_id, em.first_name, em.last_name, em.birth_date, em.tobacco_use, epmh.relation_to_subscriber, eph.plan_year, eph.coverage_type, ep2.hios_plan_id, eph.rating_area_id, eph.policy_id,\n" +
                "eph.policy_status, eph.current_ind, eph.effectuated_ind as policyAh, eph.policy_start_date, eph.policy_end_date, epfh.csr_level as policyFinAh, epfh.financial_period_start_date, epfh.financial_period_end_date, epfh.total_plan_premium_amt,\n" +
                "epfh.total_premium_reduction_amt, epfh.premium_reduction_type as policyFinAh, epfh.total_csr_amt, epmch.policy_member_coverage_status,epmh.member_id, epmh.effectuated_ind, epmch.coverage_start_date, epmch.coverage_end_date, epmch.disenrollment_reason,\n" +

...
public class Ob834DbValForMember {
    ...
    public void ob834MedRecordsValForMember(String recordType, String memPrefix, List<Map<String, String>> expectedValues) {
        switch (recordType) {
            case "medical":
                setMedicalData();
                ob834MedRecordsValidationsForMem(memPrefix,expectedValues);
                break;
            case "dental":
                setDentalData();
                ob834DenRecordsValidationsForMem(memPrefix,expectedValues);
                break;
            default:
    ...
    public void ob834MedRecordsValidationsForMem(String memPrefix,List<Map<String, String>> expectedValues){
        subscribers = basicActions.getAllSubscribers();
        for (Ob834DetailsEntity ob834DetailsEntity : ob834DetailsMedEntities) {
            if (ob834DetailsEntity.getSubscriber_indicator().equals("Y") && ob834DetailsEntity.getMember_first_name().contains(memPrefix)) {
                ...
                validateDependentMedDenDetails(memPrefix,ob834DetailsEntity);
                validateMedForMem(memPrefix, ob834DetailsEntity, expectedValues);
                setMedicalFileName(ob834DetailsEntity);
            }
        }
        softAssert.assertAll();
    }
    private void ob834DenRecordsValidationsForMem(String memPrefix, List<Map<String, String>> expectedValues) {
        for (Ob834DetailsEntity ob834DetailsEntity : ob834DetailsDenEntities) {
            if (ob834DetailsEntity.getSubscriber_indicator().equals("Y") && ob834DetailsEntity.getMember_first_name().contains(memPrefix)) {
                ...
                validateDependentMedDenDetails(memPrefix, ob834DetailsEntity);
                validateDenForMem(memPrefix, ob834DetailsEntity, expectedValues);
                setDentalFileName(ob834DetailsEntity);
            }
        }
        softAssert.assertAll();
    }
    ...
    private void denValidationsCommonForAllMembers(Ob834DetailsEntity ob834Entity, List<Map<String, String>> expectedValues, MemberDetails member) {
        ...
        String formattedFinStartDate = SharedData.getExpectedCalculatedDates_dentalPlan().getMemberFinancialStartDate()!=null? SharedData.getExpectedCalculatedDates_dentalPlan().getMemberFinancialStartDate().replaceAll("-", ""):SharedData.getExpectedCalculatedDates_dentalPlan().getFinancialStartDate().replaceAll("-", "");
    ...
    private void validateMedForMem(String memPrefix, Ob834DetailsEntity ob834Entity, List<Map<String, String>> expectedValues) {
        if(ob834Entity.getMember_first_name().contains(memPrefix)) {
    ...
    private void validateDependentMedDenDetails(String memPrefix, Ob834DetailsEntity ob834Entity) {
        if(ob834Entity.getMember_first_name().contains(memPrefix)) {
            List<MemberDetails> members = basicActions.getAllDependents();
            for (MemberDetails member : members) {
                if (member.getFirstName().equals(ob834Entity.getMember_first_name())) {
    ...
    private void validateDenForMem(String memPrefix,Ob834DetailsEntity ob834Entity, List<Map<String, String>> expectedValues) {
        if(ob834Entity.getMember_first_name().contains(memPrefix)) {
            List<MemberDetails> members = basicActions.getAllDependents();
            for (MemberDetails member : members) {
                if (member.getFirstName().equals(ob834Entity.getMember_first_name())) {
    ...
    private void medValidationsCommonForAllMembers(Ob834DetailsEntity ob834Entity, List<Map<String, String>> expectedValues, MemberDetails member) {
        ...
        String formatedFinStartDate = SharedData.getExpectedCalculatedDates_medicalPlan().getMemberFinancialStartDate()!=null ? SharedData.getExpectedCalculatedDates_medicalPlan().getMemberFinancialStartDate().replaceAll("-", ""):SharedData.getExpectedCalculatedDates_medicalPlan().getFinancialStartDate().replaceAll("-", "");
